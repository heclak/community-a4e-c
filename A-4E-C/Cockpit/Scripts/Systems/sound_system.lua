...
function post_initialize()    
    ...
    sounds = {
        ...
        Sound_Player(sndhost_cockpit, "Aircrafts/A-4E-C/a-4e_apr25_sam_fansong_e_lo", "RWR_FAN_SONG_TROUGH_E_HI", SOUND_ALWAYS),
        Sound_Player(sndhost_cockpit, "Aircrafts/A-4E-C/a-4e_apr25_sam_fansong_e_hi", "RWR_FAN_SONG_TROUGH_E_LO", SOUND_ALWAYS),
        Sound_Player(sndhost_cockpit, "Aircrafts/A-4E-C/a-4e_apr25_sam_fansong_g_lo", "RWR_FAN_SONG_TROUGH_G_LO", SOUND_ALWAYS),
        Sound_Player(sndhost_cockpit, "Aircrafts/A-4E-C/a-4e_apr25_sam_fansong_g_hi", "RWR_FAN_SONG_LORO_G", SOUND_ALWAYS),
