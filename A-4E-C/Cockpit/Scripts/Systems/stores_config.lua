...
loadout_names = {
    ...
    --CLUSTER MUNITIONS--
    ["{CBU-1/A}"]                               = "CBU-1/A ANTI-PERSONNEL - 26 BLU-4/B PER TUBE",
    ["{CBU-1/A_TER_2_L}"]                       = "CBU-1/A ANTI-PERSONNEL - 26 BLU-4/B PER TUBE",
    ["{CBU-1/A_TER_2_R}"]                       = "CBU-1/A ANTI-PERSONNEL - 26 BLU-4/B PER TUBE",
    ["{CBU-2/A}"]                               = "CBU-2/A - BLU-3/B PER TUBE",
    ["{CBU-2/A_TER_2_L}"]                       = "CBU-2/A * 2 - 12 BLU-3/B PER TUBE",
    ["{CBU-2/A_TER_2_R}"]                       = "CBU-2/A * 2 - 12 BLU-3/B PER TUBE",
    ["{CBU-2B/A}"]                              = "CBU-2B/A - 22 BLU-3/B PER TUBE",
    ["{CBU-2B/A_TER_2_L}"]                      = "CBU-2B/A * 2 - 22 BLU-3/B PER TUBE",
    ["{CBU-2B/A_TER_2_R}"]                      = "CBU-2B/A * 2 - 22 BLU-3/B PER TUBE",
    ...
    ["{Mk-77 mod 1_TER_2_C}"]                   = "BOMBS - MK-77 MOD 1 500LB. PETROLEUM *2 - TER",
    ...
    ["{AN-M57_MER_5_L}"]                        = "BOMBS - AN-M57A1 250LB. GP HE/129LB. TNT - TER",
    ["{AN-M57_MER_5_R}"]                        = "BOMBS - AN-M57A1 250LB. GP HE/129LB. TNT - MER",
    ["{AN-M57_TER_2_L}"]                        = "BOMBS - AN-M57A1 250LB. GP HE/129LB. TNT - MER",
    ["{AN-M57_TER_2_R}"]                        = "BOMBS - AN-M57A1 250LB. GP HE/129LB. TNT - TER",
    ["{AN-M57_MER_6_C}"]                        = "BOMBS - AN-M57A1 250LB. GP HE/129LB. TNT - MER",
