...
base.vertices                   = {{-(sizeX + throttle_shift + rud_shift + 3.0 * line_width + ds), -(sizeY)},
...
pitch_scale.vertices            = {{-sizeX,-line_width},
                                    {-sizeX, line_width},
                                    {sizeX, line_width},
                                    {sizeX, -line_width}}
...
roll_scale.vertices             = {{-sizeX,-line_width},
                                    {-sizeX, line_width},
                                    {sizeX, line_width},
                                    {sizeX,-line_width}}
...
stick_position.controllers      = {{"move_left_right_using_parameter", 1, sizeX},
...
throttle_scale.vertices         = {{0, -line_width},
                                    ...
                                    {sizeX, line_width},
                                    {sizeX, -line_width}}
throttle_scale.init_pos         = {-(sizeX + throttle_shift), -sizeX * 0.5}
...
throttle_index.controllers      = {{"move_up_down_using_parameter",0, sizeX}}
