...
toggleclick_left_fwd = sndhost_3D:create_sound("toggleclick_lf")
toggleclick_left_mid = sndhost_3D:create_sound("toggleclick_lm")
toggleclick_left_aft = sndhost_3D:create_sound("toggleclick_la")
toggleclick_right_fwd = sndhost_3D:create_sound("toggleclick_rf")
toggleclick_right_mid = sndhost_3D:create_sound("toggleclick_rm")
toggleclick_right_aft = sndhost_3D:create_sound("toggleclick_ra")
toggleclick_mid_fwd = sndhost_3D:create_sound("toggleclick_mf")

knobclick_left_fwd = sndhost_3D:create_sound("knob_lf")
knobclick_left_mid = sndhost_3D:create_sound("knob_lm")
knobclick_left_aft = sndhost_3D:create_sound("knob_la")
knobclick_right_fwd = sndhost_3D:create_sound("knob_rf")
knobclick_right_mid = sndhost_3D:create_sound("knob_rm")
knobclick_right_aft = sndhost_3D:create_sound("knob_ra")
knobclick_mid_fwd = sndhost_3D:create_sound("knob_mf")
