...
elements["PNT_8"] = default_2_position_tumb("Landing Gear", devices.GEAR, device_commands.Gear, 8)
...
elements["PNT_10"] = default_2_position_tumb("Tail Hook", devices.GEAR, device_commands.Hook, 10)
...
elements["PNT_83"] = multiposition_switch_limited("Master Exterior Lights", devices.EXT_LIGHTS, device_commands.extlight_master, 83, 3, 1, false, -1.0, TOGGLECLICK_LEFT_MID)

--Spoilers
elements["PNT_84"] = default_2_position_tumb("Spoiler Arm",devices.SPOILERS, device_commands.spoiler_arm,84,TOGGLECLICK_LEFT_MID)
elements["PNT_133"] = default_2_position_tumb("JATO Arming",devices.AVIONICS, device_commands.JATO_arm,133,TOGGLECLICK_LEFT_MID)
elements["PNT_134"] = default_2_position_tumb("JATO Jettison",devices.AVIONICS, device_commands.JATO_jettison,134,TOGGLECLICK_LEFT_MID)
--Speedbrake
...
elements["PNT_100"] = default_2_position_tumb("Engine Starter",devices.ENGINE, device_commands.push_starter_switch,100)
elements["PNT_100"].sound = {{STARTER_PUSH,STARTER_RELEASE}}
elements["PNT_101"] = default_3_position_tumb("Drop Tank Pressurization", devices.ENGINE, device_commands.ENGINE_drop_tanks_sw, 101, false, true, TOGGLECLICK_LEFT_MID) -- NO COMMAND
elements["PNT_103"] = default_3_position_tumb("Fuel Dump", devices.ENGINE, device_commands.ENGINE_wing_fuel_sw, 103, false, true, TOGGLECLICK_LEFT_MID) -- NO COMMAND
elements["PNT_104"] = default_2_position_tumb("Fuel Control",devices.ENGINE, device_commands.ENGINE_fuel_control_sw,104, TOGGLECLICK_LEFT_MID)
...
elements["PNT_125"] = default_2_position_tumb("Oxygen", devices.AVIONICS, device_commands.oxygen_switch, 125, TOGGLECLICK_LEFT_MID)
...
elements["PNT_135"] = multiposition_switch_limited("APC Power", devices.AFCS, device_commands.apc_engagestbyoff, 135, 3, 1.0, false, -1.0, TOGGLECLICK_LEFT_FWD)
elements["PNT_136"] = multiposition_switch_limited("APC Temperature", devices.AFCS, device_commands.apc_hotstdcold, 136, 3, 1.0, false, -1.0, TOGGLECLICK_LEFT_FWD)
...
elements["PNT_162"] = default_2_position_tumb("AFCS Heading Select",devices.AFCS, device_commands.afcs_hdg_sel,162, TOGGLECLICK_LEFT_AFT)
elements["PNT_163"] = default_2_position_tumb("AFCS Altitude",devices.AFCS, device_commands.afcs_alt,163, TOGGLECLICK_LEFT_AFT)
elements["PNT_164"] = default_axis_limited("AFCS Heading Select", devices.AFCS, device_commands.afcs_hdg_set, 164, 0.0, 0.3, false, true, {0,1} )
elements["PNT_165"] = default_2_position_tumb("AFCS Stability Augmentation (Yaw Damper)",devices.AFCS, device_commands.afcs_stab_aug,165, TOGGLECLICK_LEFT_AFT)
...
elements["PNT_390"] = multiposition_switch_limited("Gunpod", devices.WEAPON_SYSTEM, device_commands.gunpod_chargeclear, 390, 3, 1, false, -1, TOGGLECLICK_LEFT_FWD)
elements["PNT_391"] = default_2_position_tumb("Gunpod Station LH", devices.WEAPON_SYSTEM, device_commands.gunpod_l, 391, TOGGLECLICK_LEFT_FWD)
elements["PNT_392"] = default_2_position_tumb("Gunpod Station CTR", devices.WEAPON_SYSTEM, device_commands.gunpod_c, 392, TOGGLECLICK_LEFT_FWD)
elements["PNT_393"] = default_2_position_tumb("Gunpod Station RH", devices.WEAPON_SYSTEM, device_commands.gunpod_r, 393, TOGGLECLICK_LEFT_FWD)
...
elements["PNT_523"] = default_button("Chaff AUTO (ALE-29A Salvo)", devices.COUNTERMEASURES, device_commands.cm_auto, 523, 1, nil, TOGGLECLICK_LEFT_FWD)
...
elements["PNT_530"] = default_2_position_tumb("Chaff Power", devices.COUNTERMEASURES, device_commands.cm_pwr, 530, TOGGLECLICK_LEFT_FWD)
...
elements["PNT_701"] = default_2_position_tumb("Guns Charging",devices.WEAPON_SYSTEM, device_commands.arm_gun,701,TOGGLECLICK_MID_FWD)
elements["PNT_702"] = default_3_position_tumb("Bomb Arm",devices.WEAPON_SYSTEM, device_commands.arm_bomb,702,nil,true,TOGGLECLICK_MID_FWD)
elements["PNT_703"] = default_2_position_tumb("Station 1 Selector",devices.WEAPON_SYSTEM, device_commands.arm_station1,703,TOGGLECLICK_MID_FWD)
elements["PNT_704"] = default_2_position_tumb("Station 2 Selector",devices.WEAPON_SYSTEM, device_commands.arm_station2,704,TOGGLECLICK_MID_FWD)
elements["PNT_705"] = default_2_position_tumb("Station 3 Selector",devices.WEAPON_SYSTEM, device_commands.arm_station3,705,TOGGLECLICK_MID_FWD)
elements["PNT_706"] = default_2_position_tumb("Station 4 Selector",devices.WEAPON_SYSTEM, device_commands.arm_station4,706,TOGGLECLICK_MID_FWD)
elements["PNT_707"] = default_2_position_tumb("Station 5 Selector",devices.WEAPON_SYSTEM, device_commands.arm_station5,707,TOGGLECLICK_MID_FWD)
elements["PNT_708"] = multiposition_switch_limited("Weapon Function Selector",devices.WEAPON_SYSTEM, device_commands.arm_func_selector,708,7,0.1,false,nil,KNOBCLICK_MID_FWD, 2)
...
elements["PNT_721"] = default_2_position_tumb("Radar Terrain Clearance",devices.RADAR, device_commands.radar_planprofile,721,TOGGLECLICK_MID_FWD)
elements["PNT_722"] = default_2_position_tumb("Radar Range",devices.RADAR, device_commands.radar_range,722,TOGGLECLICK_MID_FWD)
elements["PNT_724"] = multiposition_switch_limited("BDHI",devices.NAV,device_commands.bdhi_mode,724,3,1.0,false,-1.0,TOGGLECLICK_MID_FWD)    -- values = -1,0,1
...
elements["PNT_744"] = multiposition_switch_limited("AWRS Mode Selector",devices.WEAPON_SYSTEM, device_commands.AWRS_stepripple,744,6,0.1,false,nil,KNOBCLICK_MID_FWD, 2)
...
-- MISCES PANEL #36
elements["PNT_720"] = default_button("Internal-External Fuel", devices.AVIONICS, device_commands.FuelGaugeExtButton, 720)
...
elements["PNT_219"] = default_2_position_tumb("Anti-Collision Light", devices.EXT_LIGHTS, device_commands.extlight_anticoll, 219, TOGGLECLICK_RIGHT_MID)
elements["PNT_220"] = multiposition_switch_limited("Fuselage Light", devices.EXT_LIGHTS, device_commands.extlight_fuselage, 220, 3, 1, true, -1.0, TOGGLECLICK_RIGHT_MID)
elements["PNT_221"] = default_2_position_tumb("Lighting Flash/Steady", devices.EXT_LIGHTS, device_commands.extlight_flashsteady, 221, TOGGLECLICK_RIGHT_MID)
...
elements["PNT_252"] = default_2_position_tumb("Emergency Generator", devices.ELECTRIC_SYSTEM, device_commands.emer_gen_bypass, 252, TOGGLECLICK_RIGHT_AFT)
elements["PNT_253"] = springloaded_forward_only_3_pos_tumb("AN/ARA-63 MCL Power", devices.MCL, device_commands.mcl_power_switch, 253, false, TOGGLECLICK_RIGHT_AFT)
...
elements["PNT_256"] = default_2_position_tumb("Fuel Transfer", devices.ENGINE, device_commands.fuel_transfer_bypass, 256, TOGGLECLICK_RIGHT_AFT)
...
-- ECM panel
elements["PNT_503"] = default_2_position_tumb("Audio ALQ",devices.RWR,device_commands.ecm_apr25_audio,	503,TOGGLECLICK_LEFT_MID)
elements["PNT_504"] = default_2_position_tumb("APR-25",	devices.RWR, device_commands.ecm_apr25_off,		504,TOGGLECLICK_LEFT_MID)
elements["PNT_501"] = default_2_position_tumb("APR-27",	devices.RWR, device_commands.ecm_apr27_off,		501,TOGGLECLICK_LEFT_MID)
...
elements["PNT_1251"] = default_2_position_tumb("Cabin Pressure", devices.ELECTRIC_SYSTEM, device_commands.cabin_pressure , 224, TOGGLECLICK_LEFT_MID)
...
elements["PNT_226"] = default_axis_limited("Cabin Temperature", devices.ELECTRIC_SYSTEM, device_commands.cabin_temp , 226, 0.0, 0.3, false, false, {0,1} )
