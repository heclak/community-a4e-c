...
elements["PNT_522"] = multiposition_switch_limited("Chaff Dispenser Select", devices.COUNTERMEASURES, device_commands.cm_bank, 522, 3, 1, true, -1, TOGGLECLICK_LEFT_FWD)
...
elements["PNT_524"] = default_axis("Chaff Dispenser 1 Counter", devices.COUNTERMEASURES, device_commands.cm_adj1, 524, 0.0, 1, false, true)
elements["PNT_525"] = default_axis("Chaff Dispenser 2 Counter", devices.COUNTERMEASURES, device_commands.cm_adj2, 525, 0.0, 1, false, true)
...
elements["PNT_700"] = multiposition_switch_limited("Emergency Release Selector Switch",devices.WEAPON_SYSTEM, device_commands.arm_emer_sel,700,7,0.1,false,nil,KNOBCLICK_MID_FWD)
...
elements["PNT_726"] = default_axis_limited( "Shrike/Sidewinder/Missile Volume Knob", devices.WEAPON_SYSTEM, device_commands.shrike_sidewinder_volume, 726, 0, 0.1, false, false, {-1.0,1.0} )
...
elements["PNT_108"] = multiposition_switch_limited("Instrument Lights Brightness Switch", devices.AVIONICS, device_commands.intlight_brightness, 108, 3, 1, true, -1.0, TOGGLECLICK_RIGHT_AFT)
...
elements["PNT_366"] = multiposition_switch_limited("Radio Frequency Mode Switch", devices.RADIO, device_commands.arc51_xmitmode, 366, 3, 1, true, -1, KNOBCLICK_RIGHT_MID)
...
elements["PNT_512"] = default_2_position_tumb("Compass Mode Switch", devices.COMPASS, device_commands.COMPASS_free_slaved_switch, 512, TOGGLECLICK_RIGHT_MID) -- NO COMMAND
