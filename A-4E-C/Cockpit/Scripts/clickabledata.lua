...
elements["PNT_177"] = default_button_axis("ASN-41 Present Position - Latitude", devices.NAV, device_commands.ppos_lat_push, device_commands.ppos_lat, 236, 177, 1, 1)
...
elements["PNT_183"] = default_button_axis("ASN-41 Present Position - Longitude", devices.NAV, device_commands.ppos_lon_push, device_commands.ppos_lon, 237, 183, 1, 1)
...
elements["PNT_190"] = default_button_axis("ASN-41 Destination - Latitude", devices.NAV, device_commands.dest_lat_push, device_commands.dest_lat, 238, 190, 1, 1)
...
elements["PNT_196"] = default_button_axis("ASN-41 Destination - Longitude", devices.NAV, device_commands.dest_lon_push, device_commands.dest_lon, 239, 196, 1, 1)
...
elements["PNT_203"] = default_button_axis("ASN-41 Magnetic Variation", devices.NAV, device_commands.asn41_magvar_push, device_commands.asn41_magvar, 240, 203, 1, 1)
...
elements["PNT_209"] = default_button_axis("ASN-41 Wind Speed", devices.NAV, device_commands.asn41_windspeed_push, device_commands.asn41_windspeed, 241, 209, 1, 1)
...
elements["PNT_213"] = default_button_axis("ASN-41 Wind Bearing", devices.NAV, device_commands.asn41_winddir_push, device_commands.asn41_winddir, 242, 213, 1, 1)
