cdata =
{
	...
	A4E_EXPERIMENTAL_RADAR_CHECK_LABEL = _('Enable Experimental Radar'),
	A4E_EXPERIMENTAL_RADAR_CHECK_TOOLTIP = _('Swaps between old lua radar and new higher performance radar.'),
}
