...
DEVICE_COMMANDS_WINDSHIELD_DEFROST = 3135,
DEVICE_COMMANDS_ASN41_MAGVAR_PUSH = 3155,
DEVICE_COMMANDS_CM_ADJ1 = 3109,
DEVICE_COMMANDS_IAS_INDEX_BUTTON = 3040,
DEVICE_COMMANDS_ARC51_FREQ_XXOOO = 3103,
...
DEVICE_COMMANDS_INTLIGHT_CONSOLE_AXIS = 3130,
DEVICE_COMMANDS_SPOILER_COVER = 3016,
DEVICE_COMMANDS_EXTLIGHT_ANTICOLL = 3077,
DEVICE_COMMANDS_EXTLIGHT_NAV = 3080,
DEVICE_COMMANDS_AWRS_DROP_INTERVAL = 3032,
DEVICE_COMMANDS_GUNSIGHTBRIGHTNESS = 3030,
DEVICE_COMMANDS_THROTTLE_AXIS_MOD = 3113,
DEVICE_COMMANDS_SPEEDBRAKE = 3024,
DEVICE_COMMANDS_GUNPOD_R = 3011,
DEVICE_COMMANDS_STBY_ATT_INDEX_KNOB = 3043,
DEVICE_COMMANDS_CPT_SECONDARY_EJECTION_HANDLE = 3150,
DEVICE_COMMANDS_AFCS_STANDBY = 3089,
DEVICE_COMMANDS_THROTTLE_CLICK = 3088,
...
DEVICE_COMMANDS_INTLIGHT_INSTRUMENTS = 3083,
DEVICE_COMMANDS_HOOK = 3021,
DEVICE_COMMANDS_ECM_APR25_AUDIO = 3115,
DEVICE_COMMANDS_CM_ADJ2 = 3110,
DEVICE_COMMANDS_GUNSIGHTELEVATIONCONTROL_AXIS = 3161,
...
DEVICE_COMMANDS_ECM_SYSTEST_LOWER = 3118,
DEVICE_COMMANDS_ECM_MSL_ALERT_AXIS_INNER = 3119,
DEVICE_COMMANDS_DOPPLER_MEMORY_TEST = 3046,
DEVICE_COMMANDS_GUNPOD_L = 3009,
DEVICE_COMMANDS_PPOS_LON = 3052,
DEVICE_COMMANDS_CABIN_PRESSURE = 3134,
DEVICE_COMMANDS_FLAPS = 3015,
DEVICE_COMMANDS_AWRS_MULTIPLIER = 3033,
DEVICE_COMMANDS_ECM_MSL_ALERT_AXIS_OUTER = 3120,
DEVICE_COMMANDS_ARC51_VOLUME = 3100,
DEVICE_COMMANDS_GUNPOD_CHARGECLEAR = 3012,
DEVICE_COMMANDS_CLOCK_STOPWATCH = 3106,
DEVICE_COMMANDS_AFCS_HDG_SET = 3093,
DEVICE_COMMANDS_INTLIGHT_WHITEFLOOD_CHANGE = 3131,
DEVICE_COMMANDS_NAV_SELECT = 3047,
DEVICE_COMMANDS_COMPASS_FREE_SLAVED_SWITCH = 3142,
...
DEVICE_COMMANDS_ARC51_FREQ_OOOXX = 3105,
DEVICE_COMMANDS_ARC51_MODE = 3098,
DEVICE_COMMANDS_ARM_EMER_SEL = 3025,
DEVICE_COMMANDS_AFCS_STAB_AUG = 3094,
DEVICE_COMMANDS_CM_PWR = 3111,
DEVICE_COMMANDS_ECM_SELECTOR_KNOB = 3121,
...
DEVICE_COMMANDS_ENGINE_FUEL_CONTROL_SW = 3146,
DEVICE_COMMANDS_SPOILER_ARM = 3017,
DEVICE_COMMANDS_RADAR_AOACOMP = 3064,
DEVICE_COMMANDS_APC_ENGAGESTBYOFF = 3096,
DEVICE_COMMANDS_ENGINE_MANUAL_FUEL_SHUTOFF = 3147,
DEVICE_COMMANDS_ARM_MASTER = 3002,
DEVICE_COMMANDS_RUDDER_TRIM = 3086,
DEVICE_COMMANDS_RADAR_STORAGE = 3057,
DEVICE_COMMANDS_ASN41_WINDSPEED_PUSH = 3156,
DEVICE_COMMANDS_ASN41_WINDSPEED = 3049,
DEVICE_COMMANDS_AWRS_DROP_INTERVAL_AXIS = 3127,
DEVICE_COMMANDS_RUDDER_AXIS_MOD = 3124,
DEVICE_COMMANDS_TACAN_VOLUME_AXIS = 3073,
DEVICE_COMMANDS_SHRIKE_SELECTOR = 3138,
DEVICE_COMMANDS_ACCEL_RESET = 3112,
DEVICE_COMMANDS_CPT_SHOULDER_HARNESS = 3149,
DEVICE_COMMANDS_MOUSE_Y = 3179,
DEVICE_COMMANDS_GUNSIGHTDAYNIGHT = 3029,
DEVICE_COMMANDS_MOUSE_X = 3178,
DEVICE_COMMANDS_EXTLIGHT_MASTER = 3074,
DEVICE_COMMANDS_FUEL_TRANSFER_BYPASS = 3177,
DEVICE_COMMANDS_SEAT_ADJUSTMENT = 3175,
DEVICE_COMMANDS_DEST_LAT_PUSH = 3153,
DEVICE_COMMANDS_EMER_GEAR_RELEASE = 3036,
DEVICE_COMMANDS_RAIN_REMOVAL = 3173,
DEVICE_COMMANDS_TACAN_ANTENNA = 3172,
DEVICE_COMMANDS_EXTLIGHT_TAIL = 3081,
DEVICE_COMMANDS_JATO_JETTISON = 3160,
DEVICE_COMMANDS_AFCS_ENGAGE = 3090,
DEVICE_COMMANDS_CM_AUTO = 3108,
...
DEVICE_COMMANDS_INTLIGHT_INSTRUMENTS_CHANGE = 3132,
DEVICE_COMMANDS_ARM_FUNC_SELECTOR = 3008,
DEVICE_COMMANDS_THROTTLE_CLICK_ITER = 3158,
DEVICE_COMMANDS_ASN41_WINDDIR_PUSH = 3157,
DEVICE_COMMANDS_DEST_LON_PUSH = 3154,
DEVICE_COMMANDS_NAV_DEAD_RECON = 3174,
DEVICE_COMMANDS_PPOS_LON_PUSH = 3152,
DEVICE_COMMANDS_PPOS_LAT_PUSH = 3151,
DEVICE_COMMANDS_ENGINE_MANUAL_FUEL_SHUTOFF_CATCH = 3148,
DEVICE_COMMANDS_ENGINE_DROP_TANKS_SW = 3145,
DEVICE_COMMANDS_EXTLIGHT_TAXI = 3076,
DEVICE_COMMANDS_RADAR_ALT_INDEXER = 3037,
DEVICE_COMMANDS_ENGINE_WING_FUEL_SW = 3144,
DEVICE_COMMANDS_AFCS_HDG_SEL = 3091,
DEVICE_COMMANDS_COMPASS_LATITUDE = 3143,
DEVICE_COMMANDS_ALTPRESSUREKNOB = 3019,
DEVICE_COMMANDS_COMPASS_PUSH_TO_SYNC = 3141,
DEVICE_COMMANDS_CABIN_TEMP = 3136,
DEVICE_COMMANDS_COMPASS_SET_HEADING = 3140,
DEVICE_COMMANDS_ASN41_MAGVAR = 3048,
DEVICE_COMMANDS_OXYGEN_SWITCH = 3139,
DEVICE_COMMANDS_TACAN_CH_MINOR = 3071,
DEVICE_COMMANDS_INTLIGHT_CONSOLE_CHANGE = 3133,
DEVICE_COMMANDS_JATO_ARM = 3159,
DEVICE_COMMANDS_ASN41_WINDDIR = 3050,
DEVICE_COMMANDS_INTLIGHT_INSTRUMENTS_AXIS = 3129,
DEVICE_COMMANDS_AWRS_STEPRIPPLE = 3034,
DEVICE_COMMANDS_INTLIGHT_BRIGHTNESS = 3085,
DEVICE_COMMANDS_SHRIKE_SIDEWINDER_VOLUME = 3126,
DEVICE_COMMANDS_ROLL_AXIS_MOD = 3123,
DEVICE_COMMANDS_WHEELBRAKE_AXIS = 3125,
DEVICE_COMMANDS_PITCH_AXIS_MOD = 3122,
DEVICE_COMMANDS_AFCS_ALT = 3092,
DEVICE_COMMANDS_ECM_SYSTEST_UPPER = 3117,
DEVICE_COMMANDS_ECM_APR27_OFF = 3116,
DEVICE_COMMANDS_ECM_APR25_OFF = 3114,
DEVICE_COMMANDS_ARC51_FREQ_PRESET = 3102,
DEVICE_COMMANDS_TACAN_MODE = 3069,
DEVICE_COMMANDS_AWRS_QUANTITY = 3031,
DEVICE_COMMANDS_RADAR_GAIN = 3060,
DEVICE_COMMANDS_EXTLIGHT_FUSELAGE = 3078,
DEVICE_COMMANDS_ARC51_XMITMODE = 3099,
DEVICE_COMMANDS_APC_HOTSTDCOLD = 3097,
DEVICE_COMMANDS_AFCS_AIL_TRIM = 3095,
DEVICE_COMMANDS_THROTTLE_AXIS = 3087,
DEVICE_COMMANDS_INTLIGHT_CONSOLE = 3084,
DEVICE_COMMANDS_INTLIGHT_WHITEFLOOD_AXIS = 3128,
DEVICE_COMMANDS_EXTLIGHT_FLASHSTEADY = 3079,
DEVICE_COMMANDS_EXTLIGHT_PROBE = 3075,
DEVICE_COMMANDS_TACAN_VOLUME = 3072,
DEVICE_COMMANDS_MAN_FLT_CONTROL_OVERRIDE = 3137,
DEVICE_COMMANDS_IAS_INDEX_KNOB = 3041,
DEVICE_COMMANDS_CM_BANK = 3107,
DEVICE_COMMANDS_EMER_GEN_DEPLOY = 3023,
DEVICE_COMMANDS_RADAR_ANGLE_AXIS = 3066,
DEVICE_COMMANDS_INTLIGHT_WHITEFLOOD = 3082,
DEVICE_COMMANDS_RADAR_RETICLE = 3062,
DEVICE_COMMANDS_ARC51_SQUELCH = 3101,
...
DEVICE_COMMANDS_ARC51_FREQ_OOXOO = 3104,
