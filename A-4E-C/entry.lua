...
update_id        = "A-4E-C",
version		 = "1.4.1",	-- increment this number on the release branch. Use semantic versioning https://semver.org
state		 = "installed",
...
if AFMenabled == true then
	...
	local FM = 
	{
		[1] = self_ID,
		[2] = 'A-4E-C',
		center_of_mass = {0.0, -0.5, 0.0}, --x=0.183, y=0.261
		moment_of_inertia = {11904, 38641, 35116, -500}, --xy = -5518
