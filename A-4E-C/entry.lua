...
update_id        = "A-4E-C",
version		 = "2.0.0-alpha-2",	-- increment this number on the release branch. Use semantic versioning https://semver.org
state		 = "installed",
...
if AFMenabled == true then
	...
	local FM = 
	{
		...
		moment_of_inertia = {10968, 39500, 35116, -1763}, --xy = -5518
