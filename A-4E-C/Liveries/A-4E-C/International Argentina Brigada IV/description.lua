...
livery = {
  {"Top", 0, "a4e-arg-brigada-iv-top", true};
  {"Top", ROUGHNESS_METALLIC, "fus_top_v494_RoughMet_lo", true};
  {"Bottom", 0, "a4e-arg-brigada-iv-bot", true};
  {"Bottom", ROUGHNESS_METALLIC, "fus_bot_v472_RoughMet_lo", true};
  {"Gear and metal", 0, "a4e-arg-brigada-iv-bot", true};
  {"Cockpit", 0, "a4e-arg-brigada-iv-bot", true};
  ...
  --{"Gear Bay", 0, "details1cockpitwheelshardpoints", true};
    ...
    {"fuel_150_a4e", 0, "a4e-arg-brigada-iv-ft", true};

    -- custom fuel tank: 300 gallon left/right
    {"fuel_300lr_a4e", 0, "a4e-arg-brigada-iv-ft", true};
