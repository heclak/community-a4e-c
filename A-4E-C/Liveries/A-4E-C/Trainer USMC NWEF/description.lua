...
livery =
{
  {"Top", DIFFUSE, "a4e_trn_usmc_nwef_top", true};
  {"Top", ROUGHNESS_METALLIC, "a4e_ext_top_RoughMet_hi", true};
  {"Bottom", DIFFUSE, "a4e_trn_usmc_nwef_bot", true};
  {"Bottom", ROUGHNESS_METALLIC, "a4e_ext_bottom_RoughMet_hi", true};
  {"Gear and metal", DIFFUSE, "a4e_trn_usmc_nwef_bot", true};
  {"Cockpit", DIFFUSE, "a4e_trn_usmc_nwef_bot", true};
  ...
  {"Pilot",	DIFFUSE, "a4e_trn_usmc_nwef_pilot", true};
