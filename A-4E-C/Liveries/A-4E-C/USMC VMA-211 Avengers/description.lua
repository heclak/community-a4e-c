...
livery = {
  {"Top", DIFFUSE, "vma211_avengers_top", true};
  ...
  {"fuel_150_a4e", DIFFUSE, "uvmapsfueltank_dft150_dft300-heart", true};

  -- custom fuel tank: 300 gallon left/right
  {"fuel_300lr_a4e", DIFFUSE, "uvmapsfueltank_dft150_dft300-heart", true};
}
