...
livery = {
  {"Top", DIFFUSE, "a4e-rnzaf-sqn75-top", true};
  {"Top", ROUGHNESS_METALLIC, "a4e_ext_top_RoughMet_lo", true};
  {"Bottom", DIFFUSE, "a4e-rnzaf-sqn75-bot", true};
  ...
  --{"Gear Bay", DIFFUSE, "a4e_ext_wheels_bays", true};
    ...
    {"fuel_150_a4e", DIFFUSE, "a4e-rnzaf-sqn75-ft", true};

    -- custom fuel tank: 300 gallon left/right
    {"fuel_300lr_a4e", DIFFUSE, "a4e-rnzaf-sqn75-ft", true};

    -- custom fuel tank: 300 gallon center
    {"fuel_300c_a4e", DIFFUSE, "a4e-rnzaf-sqn75-ft", true};
