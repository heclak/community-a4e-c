...
livery = {
  {"Top", DIFFUSE, "a4e_intl_rnzaf_sqn75_top", true};
  {"Top", ROUGHNESS_METALLIC, "a4e_ext_top_RoughMet_lo", true};
  {"Bottom", DIFFUSE, "a4e_intl_rnzaf_sqn75_bot", true};
  {"Bottom", ROUGHNESS_METALLIC, "a4e_ext_bottom_RoughMet_lo", true};
  {"Gear and metal", DIFFUSE, "a4e_intl_rnzaf_sqn75_bot", true};
  {"Cockpit", DIFFUSE, "a4e_intl_rnzaf_sqn75_bot", true};
  ...
  {"nose_010", DIFFUSE, "a4e_bort_white_smooth", true};
  {"nose_100", DIFFUSE, "a4e_bort_white_smooth", true};
  ...
  {"fuel_150_a4e", DIFFUSE, "a4e_intl_rnzaf_sqn75_ft", true};
  -- custom fuel tank: 300 gallon left/right
  {"fuel_300lr_a4e", DIFFUSE, "a4e_intl_rnzaf_sqn75_ft", true};
  -- custom fuel tank: 300 gallon center
  {"fuel_300c_a4e", DIFFUSE, "a4e_intl_rnzaf_sqn75_ft", true};
