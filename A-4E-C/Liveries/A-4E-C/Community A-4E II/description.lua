...
livery =
{
    ...
    {"tail_aggressor_010", 0, "a4e_bort_white_smooth", true};
    ...
    {"nose_aggressor_001", 0, "a4e_bort_red-gold_smooth", true};
    {"nose_aggressor_010", 0, "a4e_bort_red-gold_smooth", true};
