...
livery = {
  ...
  {"Cockpit", 0, "a4e-aggr-usn-topgun-bot", true};
  {"Gear and metal", 0, "a4e-aggr-usn-topgun-bot", true};
  ...
  {"nose_aggressor_001", 0, "a4e_bort_black", true};
  {"nose_aggressor_010", 0, "a4e_bort_black", true};
