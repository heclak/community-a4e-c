...
livery = {
  {"Top", 0, "a4e-rnzaf-kiwired-top", true};
  {"Top", ROUGHNESS_METALLIC, "fus_top_v494_RoughMet_lo", true};
  {"Bottom", 0, "a4e-rnzaf-kiwired-bot", true};
  {"Bottom", ROUGHNESS_METALLIC, "fus_bot_v472_RoughMet_lo", true};
  {"Gear and metal", 0, "a4e-rnzaf-kiwired-bot", true};
  {"Cockpit", 0, "a4e-rnzaf-kiwired-bot", true};
  ...
  {"tail_aggressor_001", 0, "a4e_bort_black_smooth", true};
  {"tail_aggressor_010", 0, "a4e_bort_black_smooth", true};
  ...
  {"fuel_150_a4e", 0, "a4e-rnzaf-kiwired-ft", true};

  -- custom fuel tank: 300 gallon left/right
  {"fuel_300lr_a4e", 0, "a4e-rnzaf-kiwired-ft", true};

  -- custom fuel tank: 300 gallon center
  {"fuel_300c_a4e", 0, "a4e-rnzaf-kiwired-ft", true};
}
