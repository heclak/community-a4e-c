...
livery = {
  {"Top", DIFFUSE, "a4e_intl_rnzaf_50th_top", true};
  {"Top", ROUGHNESS_METALLIC, "a4e_intl_rnzaf_50th_top_RoughMet", true};
  {"Bottom", DIFFUSE, "a4e_intl_rnzaf_50th_bot", true};
  {"Bottom", ROUGHNESS_METALLIC, "a4e_intl_rnzaf_50th_bot_RoughMet", true};
  {"Gear and metal", DIFFUSE, "a4e_intl_rnzaf_50th_bot", true};
  {"Cockpit", DIFFUSE, "a4e_intl_rnzaf_50th_bot", true};
  ...
  {"Pilot",	DIFFUSE, "a4e_intl_rnzaf_50_pilot", true};
    ...
    {"fuel_150_a4e", DIFFUSE, "a4e_intl_rnzaf_50th_ft", true};
    {"fuel_150_a4e", ROUGHNESS_METALLIC, "a4e_intl_rnzaf_50th_ft_RoughMet", true};

    -- custom fuel tank: 300 gallon left/right
    {"fuel_300lr_a4e", DIFFUSE, "a4e_intl_rnzaf_50th_ft", true};
    {"fuel_300lr_a4e", ROUGHNESS_METALLIC, "a4e_intl_rnzaf_50th_ft_RoughMet", true};

    -- custom fuel tank: 300 gallon center
    {"fuel_300c_a4e", DIFFUSE, "a4e_intl_rnzaf_50th_ft", true};
    {"fuel_300c_a4e", ROUGHNESS_METALLIC, "a4e_intl_rnzaf_50th_ft_RoughMet", true};
