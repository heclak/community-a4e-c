...
livery = {
  {"Top", DIFFUSE, "a4e-arg-brigada-v-top", true};
  {"Top", ROUGHNESS_METALLIC, "a4e_ext_top_RoughMet_lo", true};
  {"Bottom", DIFFUSE, "a4e-arg-brigada-v-bot", true};
  {"Bottom", ROUGHNESS_METALLIC, "a4e_ext_bottom_RoughMet_lo", true};
  {"Gear and metal", DIFFUSE, "a4e-arg-brigada-v-bot", true};
  {"Cockpit", DIFFUSE, "a4e-arg-brigada-v-bot", true};
  ...
  --{"Gear Bay", DIFFUSE, "a4e_ext_wheels_bays", true};
    ...
    {"fuel_150_a4e", DIFFUSE, "a4e-arg-brigada-v-ft", true};

    -- custom fuel tank: 300 gallon left/right
    {"fuel_300lr_a4e", DIFFUSE, "a4e-arg-brigada-v-ft", true};
