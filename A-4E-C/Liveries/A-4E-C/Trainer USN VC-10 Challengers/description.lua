...
livery = {
  {"Top", DIFFUSE, "a4e_trn_usn_vc10_challengers_top", true};
  {"Top", ROUGHNESS_METALLIC, "a4e_ext_top_RoughMet_lo", true};
  {"Bottom", DIFFUSE, "a4e_trn_usn_vc10_challengers_bot", true};
  {"Bottom", ROUGHNESS_METALLIC, "a4e_ext_bottom_RoughMet_lo", true};
  {"Gear and metal", DIFFUSE, "a4e_trn_usn_vc10_challengers_bot", true};
  {"Cockpit", DIFFUSE, "a4e_trn_usn_vc10_challengers_bot", true};
  ...
  {"Pilot",	DIFFUSE, "a4e_trn_usn_vc10_challengers_pilot", true};
  ...
  {"nose_aggressor_001", DIFFUSE, "a4e_bort_white", true};
  ...
  {"fuel_150_a4e", DIFFUSE, "a4e_trn_usn_vc10_challengers_ft.dds", true};

  -- custom fuel tank: 300 gallon left/right
  {"fuel_300lr_a4e", DIFFUSE, "a4e_trn_usn_vc10_challengers_ft.dds", true};

  -- custom fuel tank: 300 gallon center
  {"fuel_300c_a4e", DIFFUSE, "a4e_trn_usn_vc10_challengers_ft.dds", true};
