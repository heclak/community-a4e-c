...
livery = {
  ...
  {"Gear and metal", 0, "a4e-aggr-usn-vf-127-royalblues-bot", true};
  ...
  {"fuel_150_a4e", 0, "a4e-aggr-usn-vf-127-royalblues-ft", true};

  -- custom fuel tank: 300 gallon left/right
  {"fuel_300lr_a4e", 0, "a4e-aggr-usn-vf-127-royalblues-ft", true};

  -- custom fuel tank: 300 gallon center
  {"fuel_300c_a4e", 0, "a4e-aggr-usn-vf-127-royalblues-ft", true};
}
