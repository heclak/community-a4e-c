...
livery = {
  ...
  {"fuel_150_a4e", 0, "a4e-trn-usn-vc-8-redtails-ft.dds", true};

  -- custom fuel tank: 300 gallon left/right
  {"fuel_300lr_a4e", 0, "a4e-trn-usn-vc-8-redtails-ft.dds", true};

  -- custom fuel tank: 300 gallon center
  {"fuel_300c_a4e", 0, "a4e-trn-usn-vc-8-redtails-ft.dds", true};
}
