...
livery = {
  {"Top", 0, "a4e-trn-usn-vc-5-checkertails-top", true};
  {"Top", ROUGHNESS_METALLIC, "fus_top_v494_RoughMet_lo", true};
  {"Bottom", 0, "a4e-trn-usn-vc-5-checkertails-bot", true};
  {"Bottom", ROUGHNESS_METALLIC, "fus_bot_v472_RoughMet_lo", true};
  {"Gear and metal", 0, "a4e-trn-usn-vc-5-checkertails-bot", true};
  {"Cockpit", 0, "a4e-trn-usn-vc-5-checkertails-bot", true};
