...
livery = {
  {"Top", DIFFUSE, "a4e-trn-usn-vc-5-checkertails-top", true};
  {"Top", ROUGHNESS_METALLIC, "a4e_ext_top_RoughMet_lo", true};
  {"Bottom", DIFFUSE, "a4e-trn-usn-vc-5-checkertails-bot", true};
  {"Bottom", ROUGHNESS_METALLIC, "a4e_ext_bottom_RoughMet_lo", true};
  {"Gear and metal", DIFFUSE, "a4e-trn-usn-vc-5-checkertails-bot", true};
  {"Cockpit", DIFFUSE, "a4e-trn-usn-vc-5-checkertails-bot", true};
