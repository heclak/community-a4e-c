...
livery = {
  {"Top", DIFFUSE, "a4e_trn_usn_vc5_checkertails_top", true};
  {"Top", ROUGHNESS_METALLIC, "a4e_ext_top_RoughMet_lo", true};
  {"Bottom", DIFFUSE, "a4e_trn_usn_vc5_checkertails_bot", true};
  {"Bottom", ROUGHNESS_METALLIC, "a4e_ext_bottom_RoughMet_lo", true};
  {"Gear and metal", DIFFUSE, "a4e_trn_usn_vc5_checkertails_bot", true};
  {"Cockpit", DIFFUSE, "a4e_trn_usn_vc5_checkertails_bot", true};
  ...
  {"Pilot",	DIFFUSE, "a4e_trn_usn_vc5_checkertails_pilot", true};
