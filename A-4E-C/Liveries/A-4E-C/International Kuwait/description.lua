...
livery = {
  {"Top", DIFFUSE, "a4e_intl_kwt_top", true};
  {"Top", ROUGHNESS_METALLIC, "a4e_ext_top_RoughMet_lo", true};
  {"Bottom", DIFFUSE, "a4e_intl_kwt_bot", true};
  {"Bottom", ROUGHNESS_METALLIC, "a4e_ext_bottom_RoughMet_lo", true};
  {"Gear and metal", DIFFUSE, "a4e_intl_kwt_bot", true};
  {"Cockpit", DIFFUSE, "a4e_intl_kwt_bot", true};
  ...
  {"Pilot",	DIFFUSE, "a4e_intl_kwt_pilot", true};
  ...
  {"tail_001", DIFFUSE, "a4e_bort_black_arabic", true};
  {"tail_010", DIFFUSE, "a4e_bort_black_arabic", true};
  {"tail_100", DIFFUSE, "a4e_bort_black_arabic", true};
