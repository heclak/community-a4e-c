...
livery = {
  ...
  {"Gear and metal", 0, "a4e-kwt-bot", true};
  {"Cockpit", 0, "a4e-kwt-bot", true};
  ...
  {"tail_001", 0, "a4e_bort_black_arabic", true};
  {"tail_010", 0, "a4e_bort_black_arabic", true};
  {"tail_100", 0, "a4e_bort_black_arabic", true};

  -- custom fuel tanks: 150 gallon
  {"fuel_150_a4e", 0, "uvMapsFuelTank_DFT150_DFT300_lightgrey", true};

  -- custom fuel tank: 300 gallon left/right
  {"fuel_300lr_a4e", 0, "uvMapsFuelTank_DFT150_DFT300_lightgrey", true};

  -- custom fuel tank: 300 gallon center
  {"fuel_300c_a4e", 0, "uvMapsFuelTank_DFT150_DFT300_lightgrey", true};
}
