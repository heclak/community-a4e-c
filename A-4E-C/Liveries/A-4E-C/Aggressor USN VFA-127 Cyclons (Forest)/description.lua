...
livery = {
  {"Top", 0, "a4e-aggr-usn-vfa-127-cyclons-forest-top", true};
  {"Top", ROUGHNESS_METALLIC, "fus_top_v494_RoughMet_lo", true};
  {"Bottom", 0, "a4e-aggr-usn-vfa-127-cyclons-forest-bot", true};
  {"Bottom", ROUGHNESS_METALLIC, "fus_bot_v472_RoughMet_lo", true};
  {"Gear and metal", 0, "a4e-aggr-usn-vfa-127-cyclons-forest-bot", true};
  ...
  {"fuel_150_a4e", 0, "a4e-aggr-usn-vfa-127-cyclons-forest-ft", true};

  -- custom fuel tank: 300 gallon left/right
  {"fuel_300lr_a4e", 0, "a4e-aggr-usn-vfa-127-cyclons-forest-ft", true};

  -- custom fuel tank: 300 gallon center
  {"fuel_300c_a4e", 0, "a4e-aggr-usn-vfa-127-cyclons-forest-ft", true};
}
