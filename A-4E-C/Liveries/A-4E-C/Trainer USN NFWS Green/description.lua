...
livery =
{
    ...
    {"fuel_150_a4e", 0, "uvMapsFuelTank_DFT150_DFT300_nfws_green", true};

    -- custom fuel tank: 300 gallon left/right
    {"fuel_300lr_a4e", 0, "uvMapsFuelTank_DFT150_DFT300_nfws_green", true};

    -- custom fuel tank: 300 gallon center
    {"fuel_300c_a4e", 0, "uvMapsFuelTank_DFT150_DFT300_nfws_green", true};
