livery = {
    {"Bottom", 0, "a4e-aggr-usn-vf-126-bandits-bot", true};
    {"Top", 0, "a4e-aggr-usn-vf-126-bandits-top", true};
    ...
    {"flaps_001", 0, "a4e_bort_grey", true};
    {"flaps_010", 0, "a4e_bort_grey", true};
    ...
    {"fuel_150_a4e", 0, "a4e-aggr-usn-vf-126-bandits-ft", true};

    -- custom fuel tank: 300 gallon left/right
    {"fuel_300lr_a4e", 0, "a4e-aggr-usn-vf-126-bandits-ft", true};

    -- custom fuel tank: 300 gallon center
    {"fuel_300c_a4e", 0, "a4e-aggr-usn-vf-126-bandits-ft", true};
