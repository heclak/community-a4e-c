...
livery = {
  {"Top", 0, "a4e_blueangels-top-1", true};
  ...
  {"Gear and metal", 0, "a4e_blueangels-bot", true};
  {"Cockpit", 0, "a4e_blueangels-bot", true};
  ...
  {"fuel_150_a4e", 0, "a4e_blueangels-ft", true};

  -- custom fuel tank: 300 gallon left/right
  {"fuel_300lr_a4e", 0, "a4e_blueangels-ft", true};

  -- custom fuel tank: 300 gallon center
  {"fuel_300c_a4e", 0, "a4e_blueangels-ft", true};
}
