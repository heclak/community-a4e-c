...
livery = {
  {"Top", DIFFUSE, "a4e_intl_arg_top", true};
  {"Top", ROUGHNESS_METALLIC, "a4e_ext_top_RoughMet_lo", true};
  {"Bottom", DIFFUSE, "a4e_intl_arg_bot", true};
  {"Bottom", ROUGHNESS_METALLIC, "a4e_ext_bottom_RoughMet_lo", true};
  {"Gear and metal", DIFFUSE, "a4e_intl_arg_bot", true};
  {"Cockpit", DIFFUSE, "a4e_intl_arg_bot", true};
  ...
  {"Pilot",	DIFFUSE, "a4e_intl_arg_pilot", true};
  ...
  {"nose_aggressor_001", DIFFUSE, "a4e_bort_black_small_1s", true};
  {"nose_aggressor_010", DIFFUSE, "a4e_bort_black_small_10s", true};
  ...
  {"fuel_150_a4e", DIFFUSE, "a4e_ft_150_300_black", true};
  -- custom fuel tank: 300 gallon left/right
  {"fuel_300lr_a4e", DIFFUSE, "a4e_ft_150_300_black", true};
