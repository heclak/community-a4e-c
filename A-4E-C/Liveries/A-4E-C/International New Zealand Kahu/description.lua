...
livery = {
  {"Top", DIFFUSE, "a4e_intl_rnzaf_kahu_top", true};
  {"Top", ROUGHNESS_METALLIC, "a4e_ext_top_RoughMet_lo", true};
  {"Bottom", DIFFUSE, "a4e_intl_rnzaf_kahu_bot", true};
  {"Bottom", ROUGHNESS_METALLIC, "a4e_ext_bottom_RoughMet_lo", true};
  {"Gear and metal", DIFFUSE, "a4e_intl_rnzaf_kahu_bot", true};
  {"Cockpit", DIFFUSE, "a4e_intl_rnzaf_kahu_bot", true};
  ...
  {"nose_aggressor_001", DIFFUSE, "a4e_bort_black_smooth_small_1s", true};
  {"nose_aggressor_010", DIFFUSE, "a4e_bort_black_smooth_small_10s", true};

  -- 3-digit large tail numbers, used on some USN/USMC aggressors
  {"tail_001", DIFFUSE, "a4e_bort_black_smooth", true};
  {"tail_010", DIFFUSE, "a4e_bort_black_smooth", true};
  {"tail_100", DIFFUSE, "empty", true};

  -- custom fuel tanks: 150 gallon
  {"fuel_150_a4e", DIFFUSE, "a4e_intl_rnzaf_kahu_ft", true};

  -- custom fuel tank: 300 gallon left/right
  {"fuel_300lr_a4e", DIFFUSE, "a4e_intl_rnzaf_kahu_ft", true};

  -- custom fuel tank: 300 gallon center
  {"fuel_300c_a4e", DIFFUSE, "a4e_intl_rnzaf_kahu_ft", true};
}
