...
join(res.keyCommands,{
    ...
    {combos = {{key = 'P', reformers = {'RCtrl'}}}, down = Keys.UHFFreqModeInc, name = _('ARC-51 UHF Frequency Mode - CW'), category = _('Radio')},
    {combos = {{key = 'P', reformers = {'RAlt'}}}, down = Keys.UHFFreqModeDec, name = _('ARC-51 UHF Frequency Mode - CCW'), category = _('Radio')},    
