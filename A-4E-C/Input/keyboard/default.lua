...
join(res.keyCommands,{
    ...
    {combos = {{key = 'T', reformers = {'RCtrl'}}}, down = Keys.TacanModeInc,               name = _('AN/ARN-52 TACAN Mode Switch - CW'),           category = {_('Console Right'), _('AN/ARN-52 TACAN')}},
    {combos = {{key = 'T', reformers = {'RAlt'}}}, down = Keys.TacanModeDec,                name = _('AN/ARN-52 TACAN Mode Switch - CCW'),          category = {_('Console Right'), _('AN/ARN-52 TACAN')}},
    ...
    {combos = {{key = '0', reformers = {'LCtrl'}}}, down = Keys.NavReset,                   name = _('TACAN and NDB Channel Reset'),                category = {_('Console Right'), _('AN/ARN-52 TACAN')}},
    ...
    {combos = {{key = 'D', reformers = {'LAlt'}}}, down = Keys.Fuel_Transfer_Bypass_Toggle,                                                                     name = _('Fuel Transfer Switch - BYPASS/NORMAL'),       category = {_('Console Right'), _('Refueling')}},
