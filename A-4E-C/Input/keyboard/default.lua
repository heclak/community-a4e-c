...
join(res.keyCommands,{
    ...
    -- View Cockpit -----------------------------
    ---------------------------------------------
    {combos = {{key = 'M', reformers = {'RAlt'}}}, down = iCommandViewLeftMirrorOn ,	up = iCommandViewLeftMirrorOff,     name = _('Mirror Left  - ON else OFF'),   category = {_('View Cockpit')}},
    {combos = {{key = 'M', reformers = {'RCtrl'}}}, down = iCommandViewRightMirrorOn,	up = iCommandViewRightMirrorOff,    name = _('Mirror Right - ON else OFF'),   category = {_('View Cockpit')}},
    ...
    {combos = {{key = 'Q', reformers = {'LAlt'}}}, down = device_commands.cm_auto, up = device_commands.cm_auto, cockpit_device_id = devices.COUNTERMEASURES, value_down = 1.0, value_up = 0, name = _('Chaff AUTO Pushbutton (ALE-29A Salvo)'),  category = {_('AN/ALE-29A Chaff Dispensing System')}},
    ...
    {combos = {{key = 'Q', reformers = {'LCtrl'}}}, down = Keys.CmPowerToggle,                                                                  name = _('Chaff Power Switch - PWR/OFF'),           category = {_('AN/ALE-29A Chaff Dispensing System')}},
    ...
    {combos = {{key = '[', reformers = {'RCtrl'}}}, down = Keys.GunsightElevationStartUp, up = Keys.GunsightElevationStop,                                      name = _('Gunsight Elevation Control - Continuous Increase'),   category = {_('Instrument Panel'), _('Gunsight Panel')}},
    {combos = {{key = ']', reformers = {'RCtrl'}}}, down = Keys.GunsightElevationStartDown, up = Keys.GunsightElevationStop,                                    name = _('Gunsight Elevation Control - Continuous Decrease'),   category = {_('Instrument Panel'), _('Gunsight Panel')}},
    ...
    {combos = {{key = '-', reformers = {'RCtrl','RShift'}}}, down = Keys.RadarAltToggle,                                    name = _('Radar Altitude Warning - ON/OFF'),                category = {_('Instrument Panel'), _('Systems'), _('AN/APN-141 Radar Altimeter')}},
    ...
    {combos = {{key = '=', reformers = {'RCtrl'}}}, down = Keys.RadarAltWarningStartUp, up = Keys.RadarAltWarningStop,      name = _('Radar Altitude Warning - Continuous Increase'),   category = {_('Instrument Panel'), _('Systems'), _('AN/APN-141 Radar Altimeter')}},
    {combos = {{key = '-', reformers = {'RCtrl'}}}, down = Keys.RadarAltWarningStartDown, up = Keys.RadarAltWarningStop,    name = _('Radar Altitude Warning - Continuous Decrease'),   category = {_('Instrument Panel'), _('Systems'), _('AN/APN-141 Radar Altimeter')}},
    ...
    {combos = {{key = 'N', reformers = {'RShift'}}}, down = device_commands.bdhi_mode, value_down = -1, up = device_commands.bdhi_mode, value_up = 0, cockpit_device_id = devices.NAV, name = _('BDHI Switch - NAV PAC else TACAN'), category = {_('Instrument Panel'), _('Miscellaneous Switches Panel'), _('AN/ASN-41 Navigation Computer'), _('AN/ARN-52 TACAN')}},
    {combos = {{key = 'N', reformers = {'RCtrl'}}}, down = device_commands.bdhi_mode, value_down = 1, up = device_commands.bdhi_mode, value_up = 0, cockpit_device_id = devices.NAV, name = _('BDHI Switch - NAV CMPTR else TACAN'), category = {_('Instrument Panel'), _('Miscellaneous Switches Panel'), _('AN/ASN-41 Navigation Computer'), _('AN/ARN-52 TACAN')}},
    ...
    {down = Keys.Radar_Stor_Cont_Up, up = Keys.Radar_Bril_Cont_Stop,    name = _('Radar Indicator Storage Knob - Continuous Increase'),     category = {_('AN/APG-53A Radar Indicator')}},
    {down = Keys.Radar_Stor_Cont_Down, up = Keys.Radar_Bril_Cont_Stop,  name = _('Radar Indicator Storage Knob - Continuous Decrease'),     category = {_('AN/APG-53A Radar Indicator')}},
    ...
    {down = Keys.Radar_Gain_Cont_Up, up = Keys.Radar_Bril_Cont_Stop,    name = _('Radar Indicator Gain Knob - Continuous Increase'),        category = {_('AN/APG-53A Radar Indicator')}},
    {down = Keys.Radar_Gain_Cont_Down, up = Keys.Radar_Bril_Cont_Stop,  name = _('Radar Indicator Gain Knob - Continuous Decrease'),        category = {_('AN/APG-53A Radar Indicator')}},
    ...
    {down = Keys.Radar_Det_Cont_Up, up = Keys.Radar_Bril_Cont_Stop,     name = _('Radar Indicator Detail Knob - Continuous Increase'),      category = {_('AN/APG-53A Radar Indicator')}},
    {down = Keys.Radar_Det_Cont_Down, up = Keys.Radar_Bril_Cont_Stop,   name = _('Radar Indicator Detail Knob - Continuous Decrease'),      category = {_('AN/APG-53A Radar Indicator')}},
    ...
    -- {down = Keys.Radar_Ret_Cont_Up, up = Keys.Radar_Bril_Cont_Stop,     name = _('Radar Indicator Reticle Knob - Continuous Increase'),     category = {_('AN/APG-53A Radar Indicator')}},
    -- {down = Keys.Radar_Ret_Cont_Down, up = Keys.Radar_Bril_Cont_Stop,   name = _('Radar Indicator Reticle Knob - Continuous Decrease'),     category = {_('AN/APG-53A Radar Indicator')}},
    ...
    {combos = {{key = 'Q'}}, down = Keys.JATOFiringButton,                                    name = _('JATO Firing Button (ALE-29A Burst)'),       category = {_('Console Left'), _('JATO Control Panel'), _('Systems'), _('AN/ALE-29A Chaff Dispensing System')}},
    ...
    {combos = {{key = 'D', reformers = {'LCtrl'}}}, down = device_commands.ENGINE_drop_tanks_sw, up = device_commands.ENGINE_drop_tanks_sw, value_down = -1, value_up = 0, cockpit_device_id = devices.ENGINE, name = _('Drop Tank Pressurization Switch - DOWN/FLIGHT REFUEL else PRESS'),category = {_('Console Left'), _('Engine Control Panel'), _('Refueling')}},
    ...
    {combos = {{key = 'D', reformers = {'LShift'}}}, down = device_commands.ENGINE_wing_fuel_sw, value_down = 1, up = device_commands.ENGINE_wing_fuel_sw, value_up = 0, cockpit_device_id = devices.ENGINE, name = _('Fuel Dump Switch - DUMP else OFF'), category = {_('Console Left'), _('Engine Control Panel')}},
    ...
    {combos = {{key = 'A', reformers = {'LAlt'}}}, down = Keys.AFCSStandbyToggle,                                                               name = _('AFCS Standby Switch - STANDBY/OFF'),                                      category = {_('Console Left'), _('AFCS Control Panel')}},
    ...
    {combos = {{key = 'A'}}, down = Keys.AFCSEngageToggle,                                                                                      name = _('AFCS Engage Switch - ENGAGE/OFF'),                                        category = {_('Console Left'), _('AFCS Control Panel')}},
    ...
    {combos = {{key = 'A', reformers = {'LShift'}}}, down = Keys.AFCSAltitudeToggle,                                                            name = _('AFCS Altitude Switch - ALT/OFF'),                                         category = {_('Console Left'), _('AFCS Control Panel')}},
    ...
    {combos = {{key = 'A', reformers = {'LShift', 'LCtrl'}}}, down = Keys.AFCSHeadingToggle,                                                    name = _('AFCS Heading Select Switch - HDG SEL/OFF'),                               category = {_('Console Left'), _('AFCS Control Panel')}},
    ...
    {combos = {{key = 'D', reformers = {'LAlt'}}}, down = Keys.Fuel_Transfer_Bypass_Toggle,                                                                     name = _('Fuel Transfer Switch - BYPASS/NORMAL'),       category = {_('Refueling')}},
    ...
    {combos = {{key = 'I', reformers = {'RAlt'}}}, down = Keys.UHF1MHzDec,                      name = _('Radio Frequency 1 MHz - Decrease'),       category = {_('AN/ARC-51A UHF Radio')}},
    {combos = {{key = 'O', reformers = {'RCtrl'}}}, down = Keys.UHF50kHzInc,                    name = _('Radio Frequency 50 kHz - Increase'),      category = {_('AN/ARC-51A UHF Radio')}},
    {combos = {{key = 'O', reformers = {'RAlt'}}}, down = Keys.UHF50kHzDec,                     name = _('Radio Frequency 50 kHz - Decrease'),      category = {_('AN/ARC-51A UHF Radio')}},
    {combos = {{key = 'H', reformers = {'RCtrl'}}}, down = Keys.UHFPresetChannelInc,            name = _('Radio Preset Channel - Increase'),        category = {_('AN/ARC-51A UHF Radio')}},
    {combos = {{key = 'H', reformers = {'RAlt'}}}, down = Keys.UHFPresetChannelDec,             name = _('Radio Preset Channel - Decrease'),        category = {_('AN/ARC-51A UHF Radio')}},
    {combos = {{key = 'P', reformers = {'RCtrl'}}}, down = Keys.UHFFreqModeInc,                 name = _('Radio Frequency Mode Switch - CW'),       category = {_('AN/ARC-51A UHF Radio')}},
    {combos = {{key = 'P', reformers = {'RAlt'}}}, down = Keys.UHFFreqModeDec,                  name = _('Radio Frequency Mode Switch - CCW'),      category = {_('AN/ARC-51A UHF Radio')}},
