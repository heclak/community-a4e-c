...
join(res.keyCommands,{
    ...
    {combos = {{key = 'D', reformers = {'LCtrl'}}}, down = Keys.drop_tank_press_cycle,                                                                              name = _('Drop Tank Pressurization Switch - Cycle'),                            category = {_('Console Left'), _('Engine Control Panel'), _('Refueling')}},
    ...
    {combos = {{key = 'D', reformers = {'LShift'}}}, down = Keys.fuel_dump_cycle,                                                                                   name = _('Fuel Dump Switch - Cycle'),                                           category = {_('Console Left'), _('Engine Control Panel')}},
    ...
    {down = device_commands.tacan_mode,  cockpit_device_id = devices.NAV, value_down = 0.0, name = _('AN/ARN-52 TACAN Mode - OFF'),                 category = {_('AN/ARN-52 TACAN')}},
    {down = device_commands.tacan_mode,  cockpit_device_id = devices.NAV, value_down = 0.1, name = _('AN/ARN-52 TACAN Mode - REC'),                 category = {_('AN/ARN-52 TACAN')}},
    {down = device_commands.tacan_mode,  cockpit_device_id = devices.NAV, value_down = 0.2, name = _('AN/ARN-52 TACAN Mode - T/R'),                 category = {_('AN/ARN-52 TACAN')}},
    {down = device_commands.tacan_mode,  cockpit_device_id = devices.NAV, value_down = 0.3, name = _('AN/ARN-52 TACAN Mode - A/A'),                 category = {_('AN/ARN-52 TACAN')}},
