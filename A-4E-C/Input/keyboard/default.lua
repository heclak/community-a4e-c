...
join(res.keyCommands,{
    ...
    -- Systems ----------------------------------
    ---------------------------------------------
    {combos = {{key = 'E', reformers = {'LCtrl'}}}, down = iCommandPlaneEject,                                              name = _('Alternate Ejection Handle (3 times)'),                    category = {_('Aircraft Control'), _('Emergency')}},
    {combos = {{key = 'W'}}, down = Keys.BrakesOn, up = Keys.BrakesOff,                                                     name = _('Wheel Brake - ON else OFF'),          category = {_('Aircraft Control')}},
	{combos = {{key = 'W', reformers = {'LShift'}}}, down = Keys.BrakesOnLeft, up = Keys.BrakesOffLeft,						name = _('Wheel Brake Left - ON else OFF'), 	category = {_('Aircraft Control')}},
	{combos = {{key = 'W', reformers = {'LAlt'}}}, down = Keys.BrakesOnRight, up = Keys.BrakesOffRight,						name = _('Wheel Brake Right - ON else OFF'),    category = {_('Aircraft Control')}},

    ---------------------------------------------
    -- Flight Control ---------------------------
    ---------------------------------------------
    {combos = {{key = 'Up'}}, down = iCommandPlaneUpStart, up = iCommandPlaneUpStop,                                     name = _('Aircraft Pitch - DOWN'),           category = {_('Aircraft Control')}},
    {combos = {{key = 'Down'}}, down = iCommandPlaneDownStart, up = iCommandPlaneDownStop,                               name = _('Aircraft Pitch - UP'),             category = {_('Aircraft Control')}},
    {combos = {{key = 'Left'}}, down = iCommandPlaneLeftStart, up = iCommandPlaneLeftStop,                               name = _('Aircraft Roll - LEFT'),            category = {_('Aircraft Control')}},
    {combos = {{key = 'Right'}}, down = iCommandPlaneRightStart, up = iCommandPlaneRightStop,                            name = _('Aircraft Roll - RIGHT'),           category = {_('Aircraft Control')}},
    {combos = {{key = 'Z'}}, down = iCommandPlaneLeftRudderStart, up = iCommandPlaneLeftRudderStop,                      name = _('Aircraft Rudder - LEFT'),          category = {_('Aircraft Control')}},
    {combos = {{key = 'X'}}, down = iCommandPlaneRightRudderStart, up = iCommandPlaneRightRudderStop,                    name = _('Aircraft Rudder - RIGHT'),         category = {_('Aircraft Control')}},

    ---------------------------------------------
    -- Stick ------------------------------------
    ---------------------------------------------
    {combos = {{key = '.', reformers = {'RCtrl'}}}, pressed = Keys.TrimUp, up = Keys.TrimStop,       name = _('Trimmer Switch - NOSE UP'),          category = {_('Stick'), _('Aircraft Control')}},
    {combos = {{key = ';', reformers = {'RCtrl'}}}, pressed = Keys.TrimDown, up = Keys.TrimStop,     name = _('Trimmer Switch - NOSE DOWN'),        category = {_('Stick'), _('Aircraft Control')}},
    {combos = {{key = ',', reformers = {'RCtrl'}}}, pressed = Keys.TrimLeft, up = Keys.TrimStop,     name = _('Trimmer Switch - LEFT WING DOWN'),   category = {_('Stick'), _('Aircraft Control')}},
    {combos = {{key = '/', reformers = {'RCtrl'}}}, pressed = Keys.TrimRight, up = Keys.TrimStop,    name = _('Trimmer Switch - RIGHT WING DOWN'),  category = {_('Stick'), _('Aircraft Control')}},
    {combos = {{key = 'T', reformers = {'LCtrl'}}}, pressed = Keys.TrimCancel, up = Keys.TrimStop,   name = _('Trimmer Reset (Hold)'),              category = {_('Stick'), _('Aircraft Control')}},
    ...
    {combos = {{key = 'A', reformers = {'LCtrl'}}}, down = Keys.AFCSOverride,                        name = _('AFCS Override Button'),              category = {_('Stick'), _('Aircraft Control')}},
    ...
    -- Throttle Quadrant ------------------------
    ---------------------------------------------
    {combos = {{key = 'PageUp'}}, down = iCommandPlaneAUTIncreaseRegime,                                name = _('Throttle Position - Increment'),            category = {_('Throttle Quadrant'), _('Aircraft Control')}},
    {combos = {{key = 'PageDown'}}, down = iCommandPlaneAUTDecreaseRegime,                              name = _('Throttle Position - Decrement'),            category = {_('Throttle Quadrant'), _('Aircraft Control')}},
    {combos = {{key = 'Num+'}}, pressed = iCommandThrottleIncrease, up = iCommandThrottleStop,          name = _('Throttle Position Continuous - Increase'),         category = {_('Throttle Quadrant'), _('Aircraft Control')}},
    {combos = {{key = 'Num-'}}, pressed = iCommandThrottleDecrease, up = iCommandThrottleStop,          name = _('Throttle Position Continuous - Decrease'),         category = {_('Throttle Quadrant'), _('Aircraft Control')}},
    ...
    {combos = {{key = 'B'}}, down = iCommandPlaneAirBrake,                                              name = _('Speedbrake Switch - OPEN/CLOSE'),         category = {_('Throttle Grip'), _('Aircraft Control')}},
    ...
    {combos = {{key = 'B', reformers = {'LShift'}}}, down = iCommandPlaneAirBrakeOn,                    name = _('Speedbrake Switch - OPEN'),               category = {_('Throttle Grip'), _('Aircraft Control')}},
    {combos = {{key = 'B', reformers = {'LCtrl'}}}, down = iCommandPlaneAirBrakeOff,                    name = _('Speedbrake Switch - CLOSE'),              category = {_('Throttle Grip'), _('Aircraft Control')}},

    {combos = {{key = 'Z', reformers = {'RCtrl'}}}, pressed = Keys.TrimLeftRudder, up = Keys.TrimStop,  name = _('Rudder Trim Switch - Rudder Left'),       category = {_('Throttle Quadrant'), _('Aircraft Control')}},
    {combos = {{key = 'X', reformers = {'RCtrl'}}}, pressed = Keys.TrimRightRudder, up = Keys.TrimStop, name = _('Rudder Trim Switch - Rudder Right'),      category = {_('Throttle Quadrant'), _('Aircraft Control')}},

    -- Flap Switch
    {combos = {{key = 'F'}}, down = iCommandPlaneFlaps,                                                 name = _('Flaps Switch - UP/DOWN'),                  category = {_('Throttle Quadrant'), _('Aircraft Control')}},
    {combos = {{key = 'F', reformers = {'LCtrl'}}}, down = iCommandPlaneFlapsOn,                        name = _('Flaps Switch - DOWN'),                     category = {_('Throttle Quadrant'), _('Aircraft Control')}},
    {combos = {{key = 'F', reformers = {'LShift'}}}, down = iCommandPlaneFlapsOff,                      name = _('Flaps Switch - UP'),                       category = {_('Throttle Quadrant'), _('Aircraft Control')}},
    {combos = {{key = 'F', reformers = {'LAlt'}}}, down = Keys.PlaneFlapsStop,                          name = _('Flaps Switch - STOP'),                     category = {_('Throttle Quadrant'), _('Aircraft Control')}},
    ...
    ---------------------------------------------
    {down = device_commands.ecm_selector_knob, value_down = 0.0, cockpit_device_id = devices.RWR,                                                       name = _('ECM Function Selector - OFF'),                            category = {_('AN/APR-23 Radar Homing and Warning System')}},
    {down = device_commands.ecm_selector_knob, value_down = 0.33, cockpit_device_id = devices.RWR,                                                      name = _('ECM Function Selector - STBY'),                           category = {_('AN/APR-23 Radar Homing and Warning System')}},
    {down = device_commands.ecm_selector_knob, value_down = 0.66, cockpit_device_id = devices.RWR,                                                      name = _('ECM Function Selector - REC'),                            category = {_('AN/APR-23 Radar Homing and Warning System')}},
    {down = device_commands.ecm_selector_knob, value_down = 0.99, cockpit_device_id = devices.RWR,                                                      name = _('ECM Function Selector - RPT'),                            category = {_('AN/APR-23 Radar Homing and Warning System')}},
    {down = Keys.ecm_select_cw,                                                                                                                         name = _('ECM Function Selector Switch - CW'),                      category = {_('AN/APR-23 Radar Homing and Warning System')}},
    {down = Keys.ecm_select_ccw,                                                                                                                        name = _('ECM Function Selector Switch - CCW'),                     category = {_('AN/APR-23 Radar Homing and Warning System')}},
    {down = Keys.ecm_apr27_off, value_down = 1.0, value_up = 0.0,                                                                                       name = _('ECM APR-27 Switch - ON/OFF'),                             category = {_('AN/APR-23 Radar Homing and Warning System')}},
    {down = device_commands.ecm_apr27_off, up = device_commands.ecm_apr27_off, value_down = 1.0, value_up = 0.0, cockpit_device_id = devices.RWR,       name = _('ECM APR-27 Switch - ON else OFF'),                        category = {_('AN/APR-23 Radar Homing and Warning System')}},
    {down = Keys.ecm_apr25_off, value_down = 1.0, value_up = 0.0,                                                                                       name = _('ECM APR-25 Switch - ON/OFF'),                             category = {_('AN/APR-23 Radar Homing and Warning System')}},
    {down = device_commands.ecm_apr25_off, up = device_commands.ecm_apr25_off, value_down = 1.0, value_up = 0.0, cockpit_device_id = devices.RWR,       name = _('ECM APR-25 Switch - ON else OFF'),                        category = {_('AN/APR-23 Radar Homing and Warning System')}},
    {down = device_commands.ecm_apr25_audio, up = device_commands.ecm_apr25_audio, value_down = 1.0, value_up = 0.0, cockpit_device_id = devices.RWR,   name = _('ECM Audio Switch - APR/27 else APR/25'),                  category = {_('AN/APR-23 Radar Homing and Warning System')}},
    {down = Keys.ecm_OuterKnobInc,                                                                                                                      name = _('ECM Missile Volume (Outer Knob) - Rotary Increment'),     category = {_('AN/APR-23 Radar Homing and Warning System')}},
    {down = Keys.ecm_OuterKnobDec,                                                                                                                      name = _('ECM Missile Volume (Outer Knob) - Rotary Decrement'),     category = {_('AN/APR-23 Radar Homing and Warning System')}},
    {down = Keys.ecm_OuterKnobStartUp, up = Keys.ecm_OuterKnobStop,                                                                                     name = _('ECM Missile Volume (Outer Knob) - Continuous Increase'),  category = {_('AN/APR-23 Radar Homing and Warning System')}},
    {down = Keys.ecm_OuterKnobStartDown, up = Keys.ecm_OuterKnobStop,                                                                                   name = _('ECM Missile Volume (Outer Knob) - Continuous Decrease'),  category = {_('AN/APR-23 Radar Homing and Warning System')}},
    {down = Keys.ecm_InnerKnobInc,                                                                                                                      name = _('ECM PRF Volume (Inner Knob) - Rotary Increment'),         category = {_('AN/APR-23 Radar Homing and Warning System')}},
    {down = Keys.ecm_InnerKnobDec,                                                                                                                      name = _('ECM PRF Volume (Inner Knob) - Rotary Decrement'),         category = {_('AN/APR-23 Radar Homing and Warning System')}},
    {down = Keys.ecm_InnerKnobStartUp, up = Keys.ecm_InnerKnobStop,                                                                                     name = _('ECM PRF Volume (Inner Knob) - Continuous Increase'),      category = {_('AN/APR-23 Radar Homing and Warning System')}},
    {down = Keys.ecm_InnerKnobStartDown, up = Keys.ecm_InnerKnobStop,                                                                                   name = _('ECM PRF Volume (Inner Knob) - Continuous Decrease'),      category = {_('AN/APR-23 Radar Homing and Warning System')}}, 
    ...
    -- Landing Gear Handle
    {combos = {{key = 'G'}}, down = Keys.PlaneGear,                                                                         name = _('Landing Gear Handle - UP/DOWN'),                  category = {_('Instrument Panel'), _('Aircraft Control')}},
    {combos = {{key = 'G', reformers = {'LCtrl'}}}, down = Keys.PlaneGearUp,                                                name = _('Landing Gear Handle - UP'),                       category = {_('Instrument Panel'), _('Aircraft Control')}},
    {combos = {{key = 'G', reformers = {'LShift'}}}, down = Keys.PlaneGearDown,                                             name = _('Landing Gear Handle - DOWN'),                     category = {_('Instrument Panel'), _('Aircraft Control')}},
    ...
    {combos = {{key = 'G', reformers = {'LAlt'}}}, down = Keys.PlaneHook,                                                   name = _('Tail Hook Handle - UP/DOWN'),                     category = {_('Instrument Panel'), _('Aircraft Control')}},
    ...
    {down = Keys.RadarTCPlanProfile, value_down = 0,                                                                                           name = _('Radar Terrain Clearance - PLAN'),               category = {_('Instrument Panel'), _('Misc Switches Control Panel'), _('AN/APG-53A Radar')}},
    {down = Keys.RadarTCPlanProfile, value_down = -1,                                                                                          name = _('Radar Terrain Clearance - PROFILE/PLAN'),       category = {_('Instrument Panel'), _('Misc Switches Control Panel', _('AN/APG-53A Radar'))}},
    {down = Keys.RadarTCPlanProfile, value_down = 1, up = Keys.RadarTCPlanProfile, value_up = 0,                                               name = _('Radar Terrain Clearance - PROFILE else PLAN'),  category = {_('Instrument Panel'), _('Misc Switches Control Panel'), _('AN/APG-53A Radar')}},
    {down = Keys.RadarRangeLongShort, value_down = 1,                                                                                          name = _('Radar Range Switch - LONG'),                           category = {_('Instrument Panel'), _('Misc Switches Control Panel'), _('AN/APG-53A Radar')}},
    {down = Keys.RadarRangeLongShort, value_down = 0,                                                                                          name = _('Radar Range Switch - SHORT'),                          category = {_('Instrument Panel'), _('Misc Switches Control Panel'), _('AN/APG-53A Radar')}},
    {down = Keys.RadarRangeLongShort, value_down = -1,                                                                                         name = _('Radar Range Switch - LONG/SHORT'),                     category = {_('Instrument Panel'), _('Misc Switches Control Panel'), _('AN/APG-53A Radar')}},
    {down = Keys.RadarRangeLongShort, value_down = 1, up = Keys.RadarRangeLongShort, value_up = 0,                                             name = _('Radar Range Switch - LONG else SHORT'),                category = {_('Instrument Panel'), _('Misc Switches Control Panel'), _('AN/APG-53A Radar')}},

    {down = device_commands.bdhi_mode, value_down = -1, cockpit_device_id = devices.NAV,                                                       name = _('BDHI Switch - NAV PAC'),                        category = {_('Instrument Panel'), _('Misc Switches Control Panel'), _('AN/ASN-41 Navigation Computer'), _('AN/ARN-52 TACAN')}},
    {down = device_commands.bdhi_mode, value_down = 0, cockpit_device_id = devices.NAV,                                                        name = _('BDHI Switch - TACAN'),                          category = {_('Instrument Panel'), _('Misc Switches Control Panel'), _('AN/ASN-41 Navigation Computer'), _('AN/ARN-52 TACAN')}},
    {down = device_commands.bdhi_mode, value_down = 1, cockpit_device_id = devices.NAV,                                                        name = _('BDHI Switch - NAV CMPTR'),                      category = {_('Instrument Panel'), _('Misc Switches Control Panel'), _('AN/ASN-41 Navigation Computer'), _('AN/ARN-52 TACAN')}},
    {down = device_commands.bdhi_mode, value_down = -1, up = device_commands.bdhi_mode, value_up = 0, cockpit_device_id = devices.NAV,         name = _('BDHI Switch - NAV PAC else TACAN'),             category = {_('Instrument Panel'), _('Misc Switches Control Panel'), _('AN/ASN-41 Navigation Computer'), _('AN/ARN-52 TACAN')}},
    {down = device_commands.bdhi_mode, value_down = 1, up = device_commands.bdhi_mode, value_up = 0, cockpit_device_id = devices.NAV,          name = _('BDHI Switch - NAV CMPTR else TACAN'),           category = {_('Instrument Panel'), _('Misc Switches Control Panel'), _('AN/ASN-41 Navigation Computer'), _('AN/ARN-52 TACAN')}},
    ...
    -- Armament Panel 
    {down = device_commands.arm_bomb, value_down = 1, cockpit_device_id = devices.WEAPON_SYSTEM,                                                    name = _('Bomb Arm Switch - NOSE & TAIL'),                    category = {_('Instrument Panel'), _('Armament Panel')}},
    {down = device_commands.arm_bomb, value_down = 0, cockpit_device_id = devices.WEAPON_SYSTEM,                                                    name = _('Bomb Arm Switch - OFF'),                            category = {_('Instrument Panel'), _('Armament Panel')}},
    {down = device_commands.arm_bomb, value_down = -1, cockpit_device_id = devices.WEAPON_SYSTEM,                                                   name = _('Bomb Arm Switch - TAIL'),                           category = {_('Instrument Panel'), _('Armament Panel')}},
    {down = device_commands.arm_bomb, value_down = -1, up = device_commands.arm_bomb, value_up = 0, cockpit_device_id = devices.WEAPON_SYSTEM,      name = _('Bomb Arm Switch - TAIL else OFF'),                  category = {_('Instrument Panel'), _('Armament Panel')}},
    {down = device_commands.arm_bomb, value_down = 1, up = device_commands.arm_bomb, value_up = 0, cockpit_device_id = devices.WEAPON_SYSTEM,       name = _('Bomb Arm Switch - NOSE & TAIL else OFF'),           category = {_('Instrument Panel'), _('Armament Panel')}},    
    
    {combos = {{key = '1'}}, down = Keys.Station1,                                                                                                  name = _('Station 1 Selector - READY/OFF'),     category = {_('Instrument Panel'), _('Armament Panel')}},
    {combos = {{key = '2'}}, down = Keys.Station2,                                                                                                  name = _('Station 2 Selector - READY/OFF'),     category = {_('Instrument Panel'), _('Armament Panel')}},
    {combos = {{key = '3'}}, down = Keys.Station3,                                                                                                  name = _('Station 3 Selector - READY/OFF'),     category = {_('Instrument Panel'), _('Armament Panel')}},
    {combos = {{key = '4'}}, down = Keys.Station4,                                                                                                  name = _('Station 4 Selector - READY/OFF'),     category = {_('Instrument Panel'), _('Armament Panel')}},
    {combos = {{key = '5'}}, down = Keys.Station5,                                                                                                  name = _('Station 5 Selector - READY/OFF'),     category = {_('Instrument Panel'), _('Armament Panel')}},
    ...
    {combos = {{key = '7'}}, down = Keys.ArmsFuncSelectorCCW,                                                                                       name = _('Weapon Function Selector Switch - CCW'),     category = {_('Instrument Panel'), _('Armament Panel'), _('Weapons')}},
    {combos = {{key = '8'}}, down = Keys.ArmsFuncSelectorCW,                                                                                        name = _('Weapon Function Selector Switch - CW'),      category = {_('Instrument Panel'), _('Armament Panel'), _('Weapons')}},
    
    {combos = {{key = '9'}}, down = Keys.GunsReadyToggle,                                                                                           name = _('Guns Charging Switch - READY/SAFE'),         category = {_('Instrument Panel'), _('Armament Panel'), _('Weapons')}},
    ...
    {combos = {{key = '0'}}, down = Keys.MasterArmToggle,                                                                                           name = _('Master Armament Switch - ON/OFF'),                category = {_('Instrument Panel'), _('Armament Panel'), _('Weapons')}},
    ...
    {down = Keys.AWRSMultiplierToggle,      name = _('AWRS Multiplier Switch - ON/OFF'),       category = {_('Instrument Panel'), _('AWE-1 Aircraft Weapons Release System'), _('Weapons')}},
    {down = device_commands.AWRS_multiplier, up = device_commands.AWRS_multiplier, cockpit_device_id = devices.WEAPON_SYSTEM, value_down = 1.0, value_up = 0.0, name = _('AWRS Multiplier Switch - ON else OFF'), category = {_('Instrument Panel'), _('AWE-1 Aircraft Weapons Release System'), _('Weapons')}},
    ...
    -- T-Handles
    {combos = {{key = 'W', reformers = {'LCtrl'}}}, down = device_commands.emer_bomb_release, up = device_commands.emer_bomb_release, cockpit_device_id = devices.WEAPON_SYSTEM, value_down = 1.0, value_up = 0.0,  name = _('Handles - EMER BOMB Release'),    category = {_('Instrument Panel'), _('Emergency')}},
    ...
    {combos = {{key = 'S'}}, down = Keys.SpoilersArmToggle,                         name = _('Spoiler Arm Switch - ARM/OFF'),  category = {_('Console Left'), _('JATO Control Panel'), _('Aircraft Control')}},
    ...
    {combos = {{key = 'R'}}, down = iCommandPlaneFuelOn, up = iCommandPlaneFuelOff, name = _('Fuel Dump Switch - ON else OFF'),   category = {_('Console Left'), _('Engine Control Panel')}},
    {combos = {{key = 'Home', reformers = {'RShift'}}}, down = Keys.Engine_Start,   name = _('Engine Starter Switch - START'),    category = {_('Console Left'), _('Engine Control Panel')}},
    {combos = {{key = 'End', reformers = {'RShift'}}}, down = Keys.Engine_Stop,     name = _('Engine Starter Switch - ABORT'),    category = {_('Console Left'), _('Engine Control Panel')}},
    {down = device_commands.ENGINE_drop_tanks_sw, up = device_commands.ENGINE_drop_tanks_sw, value_down = 1, value_up = 0, cockpit_device_id = devices.ENGINE, name = _('Pressurization - DROP TANKS else PRESS'), category = {_('Console Left'), _('Engine Control Panel'), _('Refueling')}},
    {down = device_commands.ENGINE_drop_tanks_sw, up = device_commands.ENGINE_drop_tanks_sw, value_down = -1, value_up = 0, cockpit_device_id = devices.ENGINE, name = _('Pressurization - DOWN/FLIGHT REFUEL else PRESS'), category = {_('Console Left'), _('Engine Control Panel'), _('Refueling')}},

    -- Radar Control Panel
    {down = Keys.RadarModeOFF,                                                          name = _('Radar Mode Selector - OFF'),                             category = {_('Console Left'), _('AN/APG-53A Radar')}},
    {down = Keys.RadarModeSTBY,                                                         name = _('Radar Mode Selector - STBY'),                            category = {_('Console Left'), _('AN/APG-53A Radar')}},
    {down = Keys.RadarModeSearch,                                                       name = _('Radar Mode Selector - SRCH'),                            category = {_('Console Left'), _('AN/APG-53A Radar')}},
    {down = Keys.RadarModeTC,                                                           name = _('Radar Mode Selector - TC'),                              category = {_('Console Left'), _('AN/APG-53A Radar')}},
    {down = Keys.RadarModeA2G,                                                          name = _('Radar Mode Selector - A/G'),                             category = {_('Console Left'), _('AN/APG-53A Radar')}},
    {down = Keys.RadarModeSearch, up = Keys.RadarModeTC,                                name = _('Radar Mode Selector - SRCH else TC'),                    category = {_('Console Left'), _('AN/APG-53A Radar')}},
    {down = Keys.RadarModeA2G, up = Keys.RadarModeTC,                                   name = _('Radar Mode Selector - A/G else TC'),                     category = {_('Console Left'), _('AN/APG-53A Radar')}},
    {down = Keys.RadarMode,                                                             name = _('Radar Mode Selector Switch - Cycle'),                    category = {_('Console Left'), _('AN/APG-53A Radar')}},
    {down = Keys.RadarModeCW,                                                           name = _('Radar Mode Selector Switch - Rotary CW'),                category = {_('Console Left'), _('AN/APG-53A Radar')}},
    {down = Keys.RadarModeCCW,                                                          name = _('Radar Mode Selector Switch - Rotary CCW'),               category = {_('Console Left'), _('AN/APG-53A Radar')}},
    ...
    {combos = {{key = 'S', reformers = {'LShift'}}}, down = Keys.AFCSStabAugToggle,             name = _('AFCS Stability Augmentation Switch (Yaw Damper) - STAB AUG/OFF'),             category = {_('Console Left'), _('AFCS Control Panel')}},
    ...
    {down = device_commands.afcs_hdg_set, value_down = 1, cockpit_device_id = devices.AFCS,     name = _('AFCS Heading Select Pull-to-Set Knob - CW/Increase'),                category = {_('Console Left'), _('AFCS Control Panel')}},
    {down = device_commands.afcs_hdg_set, value_down = -1, cockpit_device_id = devices.AFCS,    name = _('AFCS Heading Select Pull-to-Set Knob - CCW/Decrease'),               category = {_('Console Left'), _('AFCS Control Panel')}},

    {down = Keys.AFCSHotasPath,                 name = _('AFCS Path Mode'),                                      category = {_('Console Left'), _('AFCS Control Panel')}},
    {down = Keys.AFCSHotasAltHdg,               name = _('AFCS Altitude + Heading Modes'),                       category = {_('Console Left'), _('AFCS Control Panel')}},
    {down = Keys.AFCSHotasAlt,                  name = _('AFCS Altitude Mode'),                                  category = {_('Console Left'), _('AFCS Control Panel')}},
    {down = Keys.AFCSHotasEngage,               name = _('AFCS Engage'),                                         category = {_('Console Left'), _('AFCS Control Panel')}},
    ...
    {combos = {{key = 'O'}}, down = Keys.OxygenToggle, name = _('Oxygen Switch - ON/OFF'), category = {_('Console Left'), _('Oxygen System')}},

    -- Canopy Control
    {combos = {{key = 'C', reformers = {'LCtrl'}}}, down = iCommandPlaneFonar, name = _('Canopy Handle - CLOSE/OPEN'), category = {_('Console Left')}},

    ---------------------------------------------
    -- Right Console ----------------------------
    ---------------------------------------------
    -- APN-153 Doppler Radar Control Panel
    {down = device_commands.doppler_select, value_down = 0.0, cockpit_device_id = devices.NAV, name = _('Doppler Radar Mode - OFF'),                         category = {_('Console Right'), _('AN/APN-153 Doppler Navigation Radar')}},
    {down = device_commands.doppler_select, value_down = 0.1, cockpit_device_id = devices.NAV, name = _('Doppler Radar Mode - STBY'),                        category = {_('Console Right'), _('AN/APN-153 Doppler Navigation Radar')}},
    {down = device_commands.doppler_select, value_down = 0.2, cockpit_device_id = devices.NAV, name = _('Doppler Radar Mode - LAND'),                        category = {_('Console Right'), _('AN/APN-153 Doppler Navigation Radar')}},
    {down = device_commands.doppler_select, value_down = 0.3, cockpit_device_id = devices.NAV, name = _('Doppler Radar Mode - SEA'),                         category = {_('Console Right'), _('AN/APN-153 Doppler Navigation Radar')}},
    {down = device_commands.doppler_select, value_down = 0.4, cockpit_device_id = devices.NAV, name = _('Doppler Radar Mode Selector - TEST'),               category = {_('Console Right'), _('AN/APN-153 Doppler Navigation Radar')}},
    {down = Keys.NavDopplerCW, name = _('Doppler Radar Mode Selector Switch - CW'), category = {_('Console Right'), _('AN/APN-153 Doppler Navigation Radar')}},
    {down = Keys.NavDopplerCCW, name = _('Doppler Radar Mode Selector Switch - CCW'), category = {_('Console Right'), _('AN/APN-153 Doppler Navigation Radar')}},
    ...
    {down = device_commands.nav_select, value_down = 0.0, cockpit_device_id = devices.NAV, name = _('Navigation Computer Selector - TEST'), category = {_('Console Right'), _('AN/ASN-41 Navigation Computer')}},
    {down = device_commands.nav_select, value_down = 0.1, cockpit_device_id = devices.NAV, name = _('Navigation Computer Selector - OFF'), category = {_('Console Right'), _('AN/ASN-41 Navigation Computer')}},
    {down = device_commands.nav_select, value_down = 0.2, cockpit_device_id = devices.NAV, name = _('Navigation Computer Selector - STBY'), category = {_('Console Right'), _('AN/ASN-41 Navigation Computer')}},
    {down = device_commands.nav_select, value_down = 0.3, cockpit_device_id = devices.NAV, name = _('Navigation Computer Selector - D1'), category = {_('Console Right'), _('AN/ASN-41 Navigation Computer')}},
    {down = device_commands.nav_select, value_down = 0.4, cockpit_device_id = devices.NAV, name = _('Navigation Computer Selector - D2'), category = {_('Console Right'), _('AN/ASN-41 Navigation Computer')}},
    {down = Keys.NavSelectCW, name = _('Navigation Computer Selector Switch - CW'), category = {_('Console Right'), _('AN/ASN-41 Navigation Computer')}},
    {down = Keys.NavSelectCCW, name = _('Navigation Computer Selector Switch - CCW'), category = {_('Console Right'), _('AN/ASN-41 Navigation Computer')}},

    -- ARN-52 TACAN Control Panel
    {combos = {{key = '0', reformers = {'LCtrl'}}}, down = Keys.NavReset,     name = _('TACAN and NDB Channel Reset'),        category = {_('AN/ARN-52 TACAN')}},
    ...
    {combos = {{key = 'T', reformers = {'RCtrl'}}}, down = Keys.TacanModeInc, name = _('TACAN Mode - CW'),                      category = {_('AN/ARN-52 TACAN')}},
    {combos = {{key = 'T', reformers = {'RAlt'}}}, down = Keys.TacanModeDec,  name = _('TACAN Mode - CCW'),                     category = {_('AN/ARN-52 TACAN')}},
    ...
    -- MCL
    {down = device_commands.mcl_power_switch, cockpit_device_id = devices.MCL, value_down = -1,  name = _('MCL (ILCS) Power Switch - OFF'),  category = {_('AN/ARA-63 MCL Microwave Landing System')}},
    {down = device_commands.mcl_power_switch, cockpit_device_id = devices.MCL, value_down = 0,  name = _('MCL (ILCS) Power Switch - ON'),  category = {_('AN/ARA-63 MCL Microwave Landing System')}},
    {down = device_commands.mcl_power_switch, up = device_commands.mcl_power_switch, cockpit_device_id = devices.MCL, value_down = 1, value_up = 0, name = _('MCL (ILCS) Power Switch - BIT else ON'),  category = {_('AN/ARA-63 MCL Microwave Landing System')}},
    {down = Keys.MCL_Power_Toggle, name = _('MCL (ILCS) Power - ON/OFF'), category = {_('AN/ARA-63 MCL Microwave Landing System')}},
    {combos = {{key = '-', reformers = {'LShift'}}}, down = Keys.MCL_Chan_Inc, name = _('MCL (ILCS) Channel Selector - CW/Increase'), category = {_('AN/ARA-63 MCL Microwave Landing System')}},
    {combos = {{key = '=', reformers = {'LShift'}}}, down = Keys.MCL_Chan_Dec, name = _('MCL (ILCS) Channel Selector - CCW/Decrease'), category = {_('AN/ARA-63 MCL Microwave Landing System')}},
	...
	-- Radio
	{combos = {{key = '\\', reformers = {'RAlt'}}}, down = Keys.radio_ptt, name = _('Radio Microphone Push to Talk (PTT)'), category = {_('Communications'), _('AN/ARC-51 UHF Radio')}},
    {combos = {{key = 'U', reformers = {'RCtrl'}}}, down = Keys.UHF10MHzInc, name = _('Radio Frequency 10 MHz - Increase'), category = {_('ARC-51 UHF Radio')}},
    {combos = {{key = 'U', reformers = {'RAlt'}}}, down = Keys.UHF10MHzDec, name = _('Radio Frequency 10 MHz - Decrease'), category = {_('AN/ARC-51 UHF Radio')}},    
    {combos = {{key = 'I', reformers = {'RCtrl'}}}, down = Keys.UHF1MHzInc, name = _('Radio Frequency 1 MHz - Increase'), category = {_('AN/ARC-51 UHF Radio')}},
    {combos = {{key = 'I', reformers = {'RAlt'}}}, down = Keys.UHF1MHzDec, name = _('Radio Frequency 1 MHz - Decrease'), category = {_('AN/ARC-51 UHF Radio')}}, 
    {combos = {{key = 'O', reformers = {'RCtrl'}}}, down = Keys.UHF50kHzInc, name = _('Radio Frequency 50 kHz - Increase'), category = {_('AN/ARC-51 UHF Radio')}},
    {combos = {{key = 'O', reformers = {'RAlt'}}}, down = Keys.UHF50kHzDec, name = _('Radio Frequency 50 kHz - Decrease'), category = {_('AN/ARC-51 UHF Radio')}}, 
    {combos = {{key = 'H', reformers = {'RCtrl'}}}, down = Keys.UHFPresetChannelInc, name = _('Radio Preset Channel - Increase'), category = {_('AN/ARC-51 UHF Radio')}},
    {combos = {{key = 'H', reformers = {'RAlt'}}}, down = Keys.UHFPresetChannelDec, name = _('Radio Preset Channel - Decrease'), category = {_('AN/ARC-51 UHF Radio')}},    
    {combos = {{key = 'P', reformers = {'RCtrl'}}}, down = Keys.UHFFreqModeInc, name = _('Radio Frequency Mode Switch - CW'), category = {_('AN/ARC-51 UHF Radio')}},
    {combos = {{key = 'P', reformers = {'RAlt'}}}, down = Keys.UHFFreqModeDec, name = _('Radio Frequency Mode Switch - CCW'), category = {_('AN/ARC-51 UHF Radio')}},    
    {down = device_commands.arc51_xmitmode, value_down = 1, cockpit_device_id = devices.RADIO, name = _('Radio Frequency Mode - PRESET CHAN'), category = {_('AN/ARC-51 UHF Radio')}},    
    {down = device_commands.arc51_xmitmode, value_down = 0, cockpit_device_id = devices.RADIO, name = _('Radio Frequency Mode - MANUAL'), category = {_('AN/ARC-51 UHF Radio')}},    
    {down = device_commands.arc51_xmitmode, value_down = -1, cockpit_device_id = devices.RADIO, name = _('Radio Frequency Mode - GD XMIT'), category = {_('AN/ARC-51 UHF Radio')}},    
    {down = Keys.UHFModeInc, name = _('Radio Mode Switch - CW'), category = {_('AN/ARC-51 UHF Radio')}},
    {down = Keys.UHFModeDec, name = _('Radio Mode Switch - CCW'), category = {_('AN/ARC-51 UHF Radio')}},    
    {down = device_commands.arc51_mode, value_down = 0.0, cockpit_device_id = devices.RADIO, name = _('Radio Mode - OFF'), category = {_('AN/ARC-51 UHF Radio')}},   
    {down = device_commands.arc51_mode, value_down = 0.1, cockpit_device_id = devices.RADIO, name = _('Radio Mode - T/R'), category = {_('AN/ARC-51 UHF Radio')}},   
    {down = device_commands.arc51_mode, value_down = 0.2, cockpit_device_id = devices.RADIO, name = _('Radio Mode - T/R + G'), category = {_('AN/ARC-51 UHF Radio')}},   
    {down = device_commands.arc51_mode, value_down = 0.3, cockpit_device_id = devices.RADIO, name = _('Radio Mode - ADF'), category = {_('AN/ARC-51 UHF Radio')}},   
    {down = Keys.UHFVolumeInc, name = _('Radio Volume - Rotary Increment'), category = {_('AN/ARC-51 UHF Radio')}},
    {down = Keys.UHFVolumeDec, name = _('Radio Volume - Rotary Decrement'), category = {_('AN/ARC-51 UHF Radio')}},    
    {down = Keys.UHFVolumeStartUp, up = Keys.UHFVolumeStop, name = _('Radio Volume - Continuous Increase'), category = {_('AN/ARC-51 UHF Radio')}},
    {down = Keys.UHFVolumeStartDown, up = Keys.UHFVolumeStop, name = _('Radio Volume - Continuous Decrease'), category = {_('AN/ARC-51 UHF Radio')}},    
