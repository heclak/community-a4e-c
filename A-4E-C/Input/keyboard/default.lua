...
join(res.keyCommands,{
	...
	-- AN/ARC-51 UHF Radio
	{combos = {{key = '\\', reformers = {'RAlt'}}}, down = Keys.radio_ptt,                      name = _('Radio Microphone Push to Talk (PTT)'),    category = {_('Throttle Grip'), _('Communications'), _('AN/ARC-51 UHF Radio')}},
