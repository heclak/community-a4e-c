...
join(res.keyCommands,{
    ...
    {down = Keys.NavPPosLatInc, up = Keys.NavPPosLatUp, name = _('Present Position Latitude Push-to-Set Knob - Increase'),   category = {_('Right Console'), _('Navigation Control Panel')}},
    {down = Keys.NavPPosLatDec, up = Keys.NavPPosLatUp, name = _('Present Position Latitude Push-to-Set Knob - Decrease'),  category = {_('Right Console'), _('Navigation Control Panel')}},
    {down = Keys.NavPPosLonInc, up = Keys.NavPPosLonUp, name = _('Present Position Longitude Push-to-Set Knob - Increase'),  category = {_('Right Console'), _('Navigation Control Panel')}},
    {down = Keys.NavPPosLonDec, up = Keys.NavPPosLonUp, name = _('Present Position Longitude Push-to-Set Knob - Decrease'), category = {_('Right Console'), _('Navigation Control Panel')}},
    {down = Keys.NavDestLatInc, up = Keys.NavDestLatUp, name = _('Destination Latitude Push-to-Set Knob - Increase'),        category = {_('Right Console'), _('Navigation Control Panel')}},
    {down = Keys.NavDestLatDec, up = Keys.NavDestLatUp, name = _('Destination Latitude Push-to-Set Knob - Decrease'),       category = {_('Right Console'), _('Navigation Control Panel')}},
    {down = Keys.NavDestLonInc, up = Keys.NavDestLonUp, name = _('Destination Longitude Push-to-Set Knob - Increase'),       category = {_('Right Console'), _('Navigation Control Panel')}},
    {down = Keys.NavDestLonDec, up = Keys.NavDestLonUp, name = _('Destination Longitude Push-to-Set Knob - Decrease'),      category = {_('Right Console'), _('Navigation Control Panel')}},
