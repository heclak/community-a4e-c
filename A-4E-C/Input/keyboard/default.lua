...
join(res.keyCommands,{
    ...
    -- Aircraft Control -------------------------
    ---------------------------------------------
    {combos = {{key = 'Up'}}, down = iCommandPlaneUpStart, up = iCommandPlaneUpStop,                                     name = _('Aircraft Pitch - DOWN'),           category = {_('Stick'), _('Aircraft Control')}},
    {combos = {{key = 'Down'}}, down = iCommandPlaneDownStart, up = iCommandPlaneDownStop,                               name = _('Aircraft Pitch - UP'),             category = {_('Stick'), _('Aircraft Control')}},
    {combos = {{key = 'Left'}}, down = iCommandPlaneLeftStart, up = iCommandPlaneLeftStop,                               name = _('Aircraft Roll - LEFT'),            category = {_('Stick'), _('Aircraft Control')}},
    {combos = {{key = 'Right'}}, down = iCommandPlaneRightStart, up = iCommandPlaneRightStop,                            name = _('Aircraft Roll - RIGHT'),           category = {_('Stick'), _('Aircraft Control')}},
    {combos = {{key = 'Z'}}, down = iCommandPlaneLeftRudderStart, up = iCommandPlaneLeftRudderStop,                      name = _('Aircraft Rudder - LEFT'),          category = {_('Stick'), _('Aircraft Control')}},
    {combos = {{key = 'X'}}, down = iCommandPlaneRightRudderStart, up = iCommandPlaneRightRudderStop,                    name = _('Aircraft Rudder - RIGHT'),         category = {_('Stick'), _('Aircraft Control')}},
    ...
    {combos = {{key = '1'}}, down = Keys.Station1,                                                                                                  name = _('Station 1 Selector - READY/OFF'),             category = {_('Instrument Panel'), _('Armament Panel'), _('Weapons')}},
    {combos = {{key = '2'}}, down = Keys.Station2,                                                                                                  name = _('Station 2 Selector - READY/OFF'),             category = {_('Instrument Panel'), _('Armament Panel'), _('Weapons')}},
    {combos = {{key = '3'}}, down = Keys.Station3,                                                                                                  name = _('Station 3 Selector - READY/OFF'),             category = {_('Instrument Panel'), _('Armament Panel'), _('Weapons')}},
    {combos = {{key = '4'}}, down = Keys.Station4,                                                                                                  name = _('Station 4 Selector - READY/OFF'),             category = {_('Instrument Panel'), _('Armament Panel'), _('Weapons')}},
    {combos = {{key = '5'}}, down = Keys.Station5,                                                                                                  name = _('Station 5 Selector - READY/OFF'),             category = {_('Instrument Panel'), _('Armament Panel'), _('Weapons')}},
    ...
    {combos = {{key = 'Home', reformers = {'RShift'}}}, down = Keys.Engine_Start,                                                                                   name = _('Engine Starter Switch - START'),                                      category = {_('Console Left'), _('Engine Control Panel'), _('Aircraft Control')}}, _('Emergency')}},
    {combos = {{key = 'End', reformers = {'RShift'}}}, down = Keys.Engine_Stop,                                                                                     name = _('Engine Starter Switch - ABORT'),                                      category = {_('Console Left'), _('Engine Control Panel'), _('Aircraft Control')}}, _('Emergency')}},
    ...
    {combos = {{key = 'T', reformers = {'RCtrl'}}}, down = Keys.TacanModeInc, name = _('AN/ARN-52 TACAN Mode - CW'),            category = {_('AN/ARN-52 TACAN')}},
    {combos = {{key = 'T', reformers = {'RAlt'}}}, down = Keys.TacanModeDec,  name = _('AN/ARN-52 TACAN Mode - CCW'),           category = {_('AN/ARN-52 TACAN')}},
	...
	-- Radio
	{combos = {{key = '\\', reformers = {'RAlt'}}}, down = Keys.radio_ptt,                      name = _('Radio Microphone Push to Talk (PTT)'),    category = {_('Stick'), _('Communications'), _('AN/ARC-51 UHF Radio')}},
    {combos = {{key = 'U', reformers = {'RCtrl'}}}, down = Keys.UHF10MHzInc,                    name = _('Radio Frequency 10 MHz - Increase'),      category = {_('AN/ARC-51 UHF Radio')}},
    ...
    {down = Keys.UHFModeInc,                                                                    name = _('AN/ARC-51 UHF Radio Mode Switch - CW'),   category = {_('AN/ARC-51 UHF Radio')}},
    {down = Keys.UHFModeDec,                                                                    name = _('AN/ARC-51 UHF Radio Mode Switch - CCW'),  category = {_('AN/ARC-51 UHF Radio')}},
    {down = device_commands.arc51_mode, value_down = 0.0, cockpit_device_id = devices.RADIO,    name = _('AN/ARC-51 UHF Radio Mode - OFF'),         category = {_('AN/ARC-51 UHF Radio')}},
    {down = device_commands.arc51_mode, value_down = 0.1, cockpit_device_id = devices.RADIO,    name = _('AN/ARC-51 UHF Radio Mode - T/R'),         category = {_('AN/ARC-51 UHF Radio')}},
    {down = device_commands.arc51_mode, value_down = 0.2, cockpit_device_id = devices.RADIO,    name = _('AN/ARC-51 UHF Radio Mode - T/R + G'),     category = {_('AN/ARC-51 UHF Radio')}},
    {down = device_commands.arc51_mode, value_down = 0.3, cockpit_device_id = devices.RADIO,    name = _('AN/ARC-51 UHF Radio Mode - ADF'),         category = {_('AN/ARC-51 UHF Radio')}},
