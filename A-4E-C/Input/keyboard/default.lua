...
join(res.keyCommands,{
    ...
    {combos = {{key = 'H', reformers = {'RCtrl'}}}, down = Keys.UHFPresetChannelInc,            name = _('Radio Preset Channel Selector - Increase'), category = {_('AN/ARC-51A UHF Radio')}},
    {combos = {{key = 'H', reformers = {'RAlt'}}}, down = Keys.UHFPresetChannelDec,             name = _('Radio Preset Channel Selector - Decrease'), category = {_('AN/ARC-51A UHF Radio')}},
