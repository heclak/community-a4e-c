...
join(res.keyCommands,{
    ...
    {combos = {{key = 'T', reformers = {'LCtrl'}}}, pressed = Keys.TrimCancel, up = Keys.TrimStop,  name = _('Trimmer Reset (Press and Hold)'),   category = {_('Stick'), _('Flight Control')}},
    ...
    {combos = {{key = 'H', reformers = {'RShift','RCtrl'}}}, down = iCommandPlane_Helmet_Brightess_Up, name = _('Night Vision Goggle Gain - Increase'), category = _('Sensors')},
    {combos = {{key = 'H', reformers = {'RShift','RAlt'}}} , down = iCommandPlane_Helmet_Brightess_Down, name = _('Night Vision Goggle Gain - Decrease'), category = _('Sensors')},
