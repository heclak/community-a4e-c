...
keyCommands = {
    ...
    {combos = {{key = 'JOY_BTN_POV1_D'}}, pressed = Keys.TrimUp, up = Keys.TrimStop, name = _('Trim: Nose Up'), category = _('Flight Control')},
    {combos = {{key = 'JOY_BTN_POV1_U'}}, pressed = Keys.TrimDown, up = Keys.TrimStop, name = _('Trim: Nose Down'), category = _('Flight Control')},
    {combos = {{key = 'JOY_BTN_POV1_L'}}, pressed = Keys.TrimLeft, up = Keys.TrimStop, name = _('Trim: Left Wing Down'), category = _('Flight Control')},
    {combos = {{key = 'JOY_BTN_POV1_R'}}, pressed = Keys.TrimRight, up = Keys.TrimStop, name = _('Trim: Right Wing Down'), category = _('Flight Control')},
    ...
    {combos = {{key = 'JOY_BTN3'}}, down = Keys.BrakesOn, up = Keys.BrakesOff, name = _('Wheel Brake On'), category = _('Systems')},
    ...
    {combos = {{key = 'JOY_BTN16'}}, down = Keys.CmBankSelectRotate, name = _('Countermeasures: Bank Select Rotate'), category = _('Countermeasures')},
