...
keyCommands = {
    ...
    {combos = {{key = 'JOY_BTN8'}}, down = iCommandPlaneAirBrakeOn, name = _('Airbrake On'), category = _('Systems')},
    {combos = {{key = 'JOY_BTN7'}}, down = iCommandPlaneAirBrakeOff, name = _('Airbrake Off'), category = _('Systems')},
    ...
    -- Weapons                                                                        
    {down = Keys.PlaneFireOn, up = Keys.PlaneFireOff, name = _('Weapon Fire'), category = _('Weapons')},
    ...
    {down = Keys.CmDrop, name = _('Countermeasures: Release'), category = _('Countermeasures')},
    ...
    -- Sensors
    --{down = iCommandPlaneChangeLock, up = iCommandPlaneChangeLockUp, name = _('Target Lock'), category = 'Sensors'},
    ...
    {combos = {{key = 'JOY_BTN_POV1_R'}}, down = Keys.RadarModeSTBY, name = _('Radar Mode: Standby'), category = _('Radar')},
    ...
    {combos = {{key = 'JOY_BTN_POV1_D'}}, down = Keys.RadarModeCW, name = _('Radar Mode CW'), category = _('Radar')},
    {combos = {{key = 'JOY_BTN_POV1_U'}}, down = Keys.RadarModeCCW, name = _('Radar Mode CCW'), category = _('Radar')},
    ...
    {combos = {{key = 'JOY_BTN24'}}, down = Keys.RadarTCPlanProfile, value_down = 1, up = Keys.RadarTCPlanProfile, value_up = 0, name = _('*Radar Terrain Clearance: Plan ELSE Profile'), category = _('Radar')},
    ...
    {combos = {{key = 'JOY_BTN13'}}, down = Keys.ExtLightMaster, value_down = 1, up = Keys.ExtLightMaster, value_up = 0, name = _('*Master Exterior Lights: ON else OFF'), category = _('Systems')},
    {combos = {{key = 'JOY_BTN14'}}, down = Keys.ExtLightMaster, value_down = -1, up = Keys.ExtLightMaster, value_up = 0, name = _('*Master Exterior Lights: BRIEF else OFF'), category = _('Systems')},
    ...
    {combos = {{key = 'JOY_BTN15'}}, down = Keys.AFCSOverride, name = _('AFCS Override (emergency)'), category = 'Autopilot'},
    ...
    {combos = {{key = 'JOY_BTN27'}}, down = Keys.AFCSHotasMode, value_down = 1, up = Keys.AFCSHotasMode, value_up = 0, name = _('*AFCS Path Mode else Altitude+Heading (HOTAS)'), category = 'Autopilot'},
