...
join(res.keyCommands,{
    ...
    {down = device_commands.arm_station1, up = device_commands.arm_station1, cockpit_device_id = devices.WEAPON_SYSTEM, value_down = 1.0, value_up = 0.0, name = _('Station 1 Selector - READY else OFF'), category = {_('Instrument Panel'), _('Armament Panel'), _('Weapons')}},
    {down = device_commands.arm_station2, up = device_commands.arm_station2, cockpit_device_id = devices.WEAPON_SYSTEM, value_down = 1.0, value_up = 0.0, name = _('Station 2 Selector - READY else OFF'), category = {_('Instrument Panel'), _('Armament Panel'), _('Weapons')}},
    {down = device_commands.arm_station3, up = device_commands.arm_station3, cockpit_device_id = devices.WEAPON_SYSTEM, value_down = 1.0, value_up = 0.0, name = _('Station 3 Selector - READY else OFF'), category = {_('Instrument Panel'), _('Armament Panel'), _('Weapons')}},
    {down = device_commands.arm_station4, up = device_commands.arm_station4, cockpit_device_id = devices.WEAPON_SYSTEM, value_down = 1.0, value_up = 0.0, name = _('Station 4 Selector - READY else OFF'), category = {_('Instrument Panel'), _('Armament Panel'), _('Weapons')}},
    {down = device_commands.arm_station5, up = device_commands.arm_station5, cockpit_device_id = devices.WEAPON_SYSTEM, value_down = 1.0, value_up = 0.0, name = _('Station 5 Selector - READY else OFF'), category = {_('Instrument Panel'), _('Armament Panel'), _('Weapons')}},
    ...
    {down = Keys.GunsReadyToggle,                                                                                                                   name = _('Guns Switch - READY/SAFE'),                 category = {_('Instrument Panel'), _('Armament Panel'), _('Weapons')}},
    {down = device_commands.arm_gun, value_down = 1, up = device_commands.arm_gun, value_up = 0, cockpit_device_id = devices.WEAPON_SYSTEM,         name = _('Guns Switch - READY else SAFE'),            category = {_('Instrument Panel'), _('Armament Panel'), _('Weapons')}},
    ...
    {down = device_commands.arm_emer_sel, cockpit_device_id = devices.WEAPON_SYSTEM, value_down = 0.0, name = _('Emergency Release Selector - WNG'), category = {_('Instrument Panel'), _('Armament Panel'), _('Emergency')}},
    {down = device_commands.arm_emer_sel, cockpit_device_id = devices.WEAPON_SYSTEM, value_down = 0.1, name = _('Emergency Release Selector - 1'), category = {_('Instrument Panel'), _('Armament Panel'), _('Emergency')}},
    {down = device_commands.arm_emer_sel, cockpit_device_id = devices.WEAPON_SYSTEM, value_down = 0.2, name = _('Emergency Release Selector - 2'), category = {_('Instrument Panel'), _('Armament Panel'), _('Emergency')}},
    {down = device_commands.arm_emer_sel, cockpit_device_id = devices.WEAPON_SYSTEM, value_down = 0.3, name = _('Emergency Release Selector - 3'), category = {_('Instrument Panel'), _('Armament Panel'), _('Emergency')}},
    {down = device_commands.arm_emer_sel, cockpit_device_id = devices.WEAPON_SYSTEM, value_down = 0.4, name = _('Emergency Release Selector - 4'), category = {_('Instrument Panel'), _('Armament Panel'), _('Emergency')}},
    {down = device_commands.arm_emer_sel, cockpit_device_id = devices.WEAPON_SYSTEM, value_down = 0.5, name = _('Emergency Release Selector - 5'), category = {_('Instrument Panel'), _('Armament Panel'), _('Emergency')}},
    {down = device_commands.arm_emer_sel, cockpit_device_id = devices.WEAPON_SYSTEM, value_down = 0.6, name = _('Emergency Release Selector - AL'), category = {_('Instrument Panel'), _('Armament Panel'), _('Emergency')}},
    ...
    {down = Keys.Engine_Start,                                                                name = _('Engine Starter Switch - START'),        category = {_('Console Left'), _('Engine Control Panel')}},
    {down = Keys.Engine_Stop,                                                                 name = _('Engine Starter Switch - ABORT'),        category = {_('Console Left'), _('Engine Control Panel')}},
    ...
    {down = device_commands.nav_select, value_down = 0.0, cockpit_device_id = devices.NAV, name = _('Navigation Computer Function Selector - TEST'), category = {_('Console Right'), _('AN/ASN-41 Navigation Computer')}},
    {down = device_commands.nav_select, value_down = 0.1, cockpit_device_id = devices.NAV, name = _('Navigation Computer Function Selector - OFF'), category = {_('Console Right'), _('AN/ASN-41 Navigation Computer')}},
    {down = device_commands.nav_select, value_down = 0.2, cockpit_device_id = devices.NAV, name = _('Navigation Computer Function Selector - STBY'), category = {_('Console Right'), _('AN/ASN-41 Navigation Computer')}},
    {down = device_commands.nav_select, value_down = 0.3, cockpit_device_id = devices.NAV, name = _('Navigation Computer Function Selector - D1'), category = {_('Console Right'), _('AN/ASN-41 Navigation Computer')}},
    {down = device_commands.nav_select, value_down = 0.4, cockpit_device_id = devices.NAV, name = _('Navigation Computer Function Selector - D2'), category = {_('Console Right'), _('AN/ASN-41 Navigation Computer')}},
    {down = Keys.NavSelectCW, name = _('Navigation Computer Function Selector Switch - CW'), category = {_('Console Right'), _('AN/ASN-41 Navigation Computer')}},
    {down = Keys.NavSelectCCW, name = _('Navigation Computer Function Selector Switch - CCW'), category = {_('Console Right'), _('AN/ASN-41 Navigation Computer')}},
    ...
    {down = Keys.TacanModeInc,      name = _('TACAN Mode - CW'),                                            category = {_('AN/ARN-52 TACAN')}},
    {down = Keys.TacanModeDec,      name = _('TACAN Mode - CCW'),                                           category = {_('AN/ARN-52 TACAN')}},
    ...
    {down = Keys.MCL_Chan_Inc, name = _('MCL (ILCS) Channel Selector - CW/Increase'), category = {_('AN/ARA-63 MCL Microwave Landing System')}},
    {down = Keys.MCL_Chan_Dec, name = _('MCL (ILCS) Channel Selector - CCW/Decrease'), category = {_('AN/ARA-63 MCL Microwave Landing System')}},
	...
	-- Radio
	{down = Keys.radio_ptt, name = _('Radio Microphone Push to Talk (PTT)'), category = {_('Communications'), _('AN/ARC-51 UHF Radio')}},
    ...
    {down = Keys.UHF1MHzDec, name = _('Radio Frequency 1 MHz - Decrease'), category = {_('AN/ARC-51 UHF Radio')}}, 
    {down = Keys.UHF50kHzInc, name = _('Radio Frequency 50 kHz - Increase'), category = {_('AN/ARC-51 UHF Radio')}},
    {down = Keys.UHF50kHzDec, name = _('Radio Frequency 50 kHz - Decrease'), category = {_('AN/ARC-51 UHF Radio')}}, 
    {down = Keys.UHFPresetChannelInc, name = _('Radio Preset Channel - Increase'), category = {_('AN/ARC-51 UHF Radio')}},
    {down = Keys.UHFPresetChannelDec, name = _('Radio Preset Channel - Decrease'), category = {_('AN/ARC-51 UHF Radio')}},    
    {down = Keys.UHFFreqModeInc, name = _('Radio Frequency Mode Switch - CW'), category = {_('AN/ARC-51 UHF Radio')}},
    {down = Keys.UHFFreqModeDec, name = _('Radio Frequency Mode Switch - CCW'), category = {_('AN/ARC-51 UHF Radio')}},    
...
join(res.axisCommands,{
    ...
    -- ECM Control Panel / AN/APR-23 Radar Homing and Warning System
    --------------------------------------------- 
    {action = device_commands.ecm_msl_alert_axis_inner,     cockpit_device_id = devices.RWR,            name = _('ECM PRF Volume (Inner Knob)'),            category = {_('AN/APR-23 Radar Homing and Warning System')}}, 
    {action = device_commands.ecm_msl_alert_axis_outer,     cockpit_device_id = devices.RWR,            name = _('ECM Missile Volume (Outer Knob)'),        category = {_('AN/APR-23 Radar Homing and Warning System')}}, 
    ...
    {action = device_commands.radar_angle_axis_abs,         cockpit_device_id = devices.RADAR,          name = _('Radar Antenna Tilt - Absolute'),          category = {_('Console Left'), _('Radar Control Panel', _('AN/APG-53A Radar'))}},

    -- Interior Lights Panel
    {action = device_commands.intlight_instruments_AXIS,    cockpit_device_id = devices.AVIONICS,       name = _('Instrument Lights Control Knob'),         category = {_('Console Right'), _('Interior Lights Control Panel')}},
    {action = device_commands.intlight_console_AXIS,        cockpit_device_id = devices.AVIONICS,       name = _('Console Lights Control Knob'),            category = {_('Console Right'), _('Interior Lights Control Panel')}},
    {action = device_commands.intlight_whiteflood_AXIS,     cockpit_device_id = devices.AVIONICS,       name = _('White Floodlights Control'),              category = {_('Console Right'), _('Interior Lights Control Panel')}},
