...
join(res.keyCommands,{
    ...
    {down = Keys.UHFPresetChannelInc,                                                           name = _('Radio Preset Channel - Increase'),        category = {_('AN/ARC-51A UHF Radio')}},
    {down = Keys.UHFPresetChannelDec,                                                           name = _('Radio Preset Channel - Decrease'),        category = {_('AN/ARC-51A UHF Radio')}},
