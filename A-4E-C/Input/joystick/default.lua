...
join(res.keyCommands,{
    ...
    {down = Keys.BrakesOn, up = Keys.BrakesOff,                         name = _('Wheel Brake - Hold'),       category = {_('Systems')}},
	{down = Keys.BrakesOnLeft, up = Keys.BrakesOffLeft,					name = _('Wheel Brake Left - Hold'), 	category = {_('Systems')}},
	{down = Keys.BrakesOnRight, up = Keys.BrakesOffRight,				name = _('Wheel Brake Right - Hold'), category = {_('Systems')}},
    ...
    {down = Keys.RadarModeSTBY,                                                         name = _('Radar Mode Selector - STANDBY'),                              category = {_('Left Console'), _('Radar Control Panel')}},
    {down = Keys.RadarModeSearch,                                                       name = _('Radar Mode Selector - SEARCH'),                               category = {_('Left Console'), _('Radar Control Panel')}},
    {down = Keys.RadarModeTC,                                                           name = _('Radar Mode Selector - TERRAIN CLEARANCE'),                    category = {_('Left Console'), _('Radar Control Panel')}},
    {down = Keys.RadarModeA2G,                                                          name = _('Radar Mode Selector - A2G'),                                  category = {_('Left Console'), _('Radar Control Panel')}},
    {down = Keys.RadarModeSearch, up = Keys.RadarModeTC,                                name = _('Radar Mode Selector - SEARCH else TC'),                       category = {_('Left Console'), _('Radar Control Panel')}},
    {down = Keys.RadarModeA2G, up = Keys.RadarModeTC,                                   name = _('Radar Mode Selector - A2G else TC'),                          category = {_('Left Console'), _('Radar Control Panel')}},
    {down = Keys.RadarMode,                                                             name = _('Radar Mode Selector Switch - Cycle'),                         category = {_('Left Console'), _('Radar Control Panel')}},
    ...
    {down = Keys.ToggleSlatsLock,       name = _('Lock/Unlock Slats'),  category = {_('Communications')}},
